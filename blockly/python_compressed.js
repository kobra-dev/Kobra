...
(function (root, factory) {
  ...
  Blockly.Python.colour_rgb = function (a) {
    var b = Blockly.Python.provideFunction_("colour_rgb", [
      ...
      d =
        Blockly.Python.valueToCode(a, "GREEN", Blockly.Python.ORDER_NONE) || 0;
  ...
  Blockly.Python.lists_repeat = function (a) {
    var b =
      Blockly.Python.valueToCode(a, "ITEM", Blockly.Python.ORDER_NONE) ||
      "None";
    a =
      Blockly.Python.valueToCode(
        a,
  ...
  Blockly.Python.lists_setIndex = function (a) {
    var b =
      ...
      e =
        Blockly.Python.valueToCode(a, "TO", Blockly.Python.ORDER_NONE) ||
        "None";
    switch (d) {
      case "FIRST":
  ...
  Blockly.Python.controls_if = function (a) {
    ...
    do {
      var d =
        ...
        "False";
      var e =
        Blockly.Python.statementToCode(a, "DO" + b) || Blockly.Python.PASS;
  ...
  Blockly.Python.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
      ...
      : Blockly.Python.valueToCode(a, "TIMES", Blockly.Python.ORDER_NONE) ||
        "0";
  ...
  Blockly.Python.math_single = function (a) {
    ...
    a =
      "SIN" == b || "COS" == b || "TAN" == b
        ...
        : Blockly.Python.valueToCode(a, "NUM", Blockly.Python.ORDER_NONE) ||
          "0";
    switch (b) {
      case "ABS":
        c = "math.fabs(" + a + ")";
  ...
  Blockly.Python.math_constrain = function (a) {
    var b =
        ...
        "0",
      c =
        Blockly.Python.valueToCode(a, "LOW", Blockly.Python.ORDER_NONE) || "0";
    a =
  ...
  Blockly.Python.math_atan2 = function (a) {
    Blockly.Python.definitions_.import_math = "import math";
    var b =
      Blockly.Python.valueToCode(a, "X", Blockly.Python.ORDER_NONE) || "0";
    return [
      "math.atan2(" +
  ...
  Blockly.Python.procedures_defreturn = function (a) {
    ...
    Blockly.Python.STATEMENT_PREFIX &&
      (c += Blockly.Python.injectId(Blockly.Python.STATEMENT_PREFIX, a));
    Blockly.Python.STATEMENT_SUFFIX &&
      (c += Blockly.Python.injectId(Blockly.Python.STATEMENT_SUFFIX, a));
    c && (c = Blockly.Python.prefixLines(c, Blockly.Python.INDENT));
    var l = "";
    Blockly.Python.INFINITE_LOOP_TRAP &&
      (l = Blockly.Python.prefixLines(
    ...
    e = a.getVars();
    for (f = 0; f < e.length; f++)
      m[f] = Blockly.Python.variableDB_.getName(
        e[f],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    b = "def " + d + "(" + m.join(", ") + "):\n" + b + c + l + h + k + g;
  ...
  Blockly.Python.procedures_callreturn = function (a) {
    for (
      ...
      c[e] =
        Blockly.Python.valueToCode(a, "ARG" + e, Blockly.Python.ORDER_NONE) ||
        "None";
