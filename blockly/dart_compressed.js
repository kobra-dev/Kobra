...
(function (root, factory) {
  ...
  Blockly.Dart.init = function (a) {
    ...
    Blockly.Dart.variableDB_
      ...
      : (Blockly.Dart.variableDB_ = new Blockly.Names(
    ...
    for (
      ...
      b.push(
        Blockly.Dart.variableDB_.getName(
          c[d],
    ...
    b.length &&
      (Blockly.Dart.definitions_.variables = "var " + b.join(", ") + ";");
  };
  ...
  Blockly.Dart.multiline_quote_ = function (a) {
    a = a.replace(/'''/g, "\\'\\'\\'");
    return "'''" + a + "'''";
  };
  Blockly.Dart.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = Blockly.utils.string.wrap(e, Blockly.Dart.COMMENT_WRAP - 3)),
        (d = a.getProcedureDef
      ...
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type == Blockly.INPUT_VALUE &&
          ...
          (e = Blockly.Dart.allNestedComments(e)) &&
          (d += Blockly.Dart.prefixLines(e, "// "));
    }
  ...
  Blockly.Dart.getAdjusted = function (a, b, c, d, e) {
    ...
    a = c
      ? Blockly.Dart.valueToCode(a, b, Blockly.Dart.ORDER_ADDITIVE) || f
      : d
      ? Blockly.Dart.valueToCode(a, b, Blockly.Dart.ORDER_UNARY_PREFIX) || f
      : Blockly.Dart.valueToCode(a, b, e) || f;
    if (Blockly.isNumber(a)) (a = parseInt(a, 10) + c), d && (a = -a);
      ...
      d &&
        ((a = c ? "-(" + a + ")" : "-" + a),
        (g = Blockly.Dart.ORDER_UNARY_PREFIX));
      g = Math.floor(g);
      e = Math.floor(e);
      g && e >= g && (a = "(" + a + ")");
    }
  ...
  Blockly.Dart.colour_picker = function (a) {
    return [
      Blockly.Dart.quote_(a.getFieldValue("COLOUR")),
  ...
  Blockly.Dart.colour_random = function (a) {
    ...
    return [
      Blockly.Dart.provideFunction_("colour_random", [
  ...
  Blockly.Dart.colour_rgb = function (a) {
    ...
    Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
    return [
      Blockly.Dart.provideFunction_("colour_rgb", [
        "String " +
  ...
  Blockly.Dart.colour_blend = function (a) {
    var b =
        Blockly.Dart.valueToCode(a, "COLOUR1", Blockly.Dart.ORDER_NONE) ||
        "'#000000'",
      c =
        Blockly.Dart.valueToCode(a, "COLOUR2", Blockly.Dart.ORDER_NONE) ||
        "'#000000'";
    a = Blockly.Dart.valueToCode(a, "RATIO", Blockly.Dart.ORDER_NONE) || 0.5;
    Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
    return [
      Blockly.Dart.provideFunction_("colour_blend", [
        "String " +
          Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Dart.lists_create_with = function (a) {
    for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++)
      b[c] =
        Blockly.Dart.valueToCode(a, "ADD" + c, Blockly.Dart.ORDER_NONE) ||
        "null";
    return ["[" + b.join(", ") + "]", Blockly.Dart.ORDER_ATOMIC];
  };
  Blockly.Dart.lists_repeat = function (a) {
    var b =
      Blockly.Dart.valueToCode(a, "ITEM", Blockly.Dart.ORDER_NONE) || "null";
    return [
      "new List.filled(" +
  ...
  Blockly.Dart.lists_length = function (a) {
    return [
      (Blockly.Dart.valueToCode(a, "VALUE", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
        "[]") + ".length",
      Blockly.Dart.ORDER_UNARY_POSTFIX,
    ];
  };
  ...
  Blockly.Dart.lists_indexOf = function (a) {
    ...
    return a.workspace.options.oneBasedIndex
      ? [b + " + 1", Blockly.Dart.ORDER_ADDITIVE]
      : [b, Blockly.Dart.ORDER_UNARY_POSTFIX];
  };
  Blockly.Dart.lists_getIndex = function (a) {
    function b() {
      var a = Blockly.Dart.variableDB_.getDistinctName(
          "tmp_list",
          Blockly.VARIABLE_CATEGORY_NAME
        ),
        b = "List " + a + " = " + e + ";\n";
    ...
    if (
      (("RANDOM" != d || "REMOVE" != c) && "FROM_END" != d) ||
      e.match(/^\w+$/)
    )
      switch (d) {
        case "FIRST":
          if ("GET" == c)
            return [e + ".first", Blockly.Dart.ORDER_UNARY_POSTFIX];
          if ("GET_REMOVE" == c)
            return [e + ".removeAt(0)", Blockly.Dart.ORDER_UNARY_POSTFIX];
          if ("REMOVE" == c) return e + ".removeAt(0);\n";
          break;
        case "LAST":
          if ("GET" == c)
            return [e + ".last", Blockly.Dart.ORDER_UNARY_POSTFIX];
          if ("GET_REMOVE" == c)
            return [e + ".removeLast()", Blockly.Dart.ORDER_UNARY_POSTFIX];
          if ("REMOVE" == c) return e + ".removeLast();\n";
          break;
        case "FROM_START":
          d = Blockly.Dart.getAdjusted(a, "AT");
          if ("GET" == c)
            return [e + "[" + d + "]", Blockly.Dart.ORDER_UNARY_POSTFIX];
          if ("GET_REMOVE" == c)
            return [
              e + ".removeAt(" + d + ")",
              Blockly.Dart.ORDER_UNARY_POSTFIX,
        ...
        case "RANDOM":
          ...
          if ("REMOVE" == c)
            return (
              (c = Blockly.Dart.variableDB_.getDistinctName(
                "tmp_x",
                Blockly.VARIABLE_CATEGORY_NAME
              )),
              "int " +
          ...
          if ("GET" == c)
            return (
              (c = Blockly.Dart.provideFunction_("lists_get_random_item", [
                "dynamic " +
                  Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
                  "(List my_list) {",
              ...
              [c + "(" + e + ")", Blockly.Dart.ORDER_UNARY_POSTFIX]
            );
          if ("GET_REMOVE" == c)
            return (
              (c = Blockly.Dart.provideFunction_("lists_remove_random_item", [
                "dynamic " +
                  Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
                  "(List my_list) {",
                "  int x = new Math.Random().nextInt(my_list.length);",
      ...
      if ("GET" == c)
        return (
          (d = Blockly.Dart.getAdjusted(a, "AT", 1)),
          (c = Blockly.Dart.provideFunction_("lists_get_from_end", [
            "dynamic " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
              "(List my_list, num x) {",
            "  x = my_list.length - x;",
          ...
          [c + "(" + e + ", " + d + ")", Blockly.Dart.ORDER_UNARY_POSTFIX]
        );
      if ("GET_REMOVE" == c)
        return (
          (d = Blockly.Dart.getAdjusted(a, "AT", 1)),
          (c = Blockly.Dart.provideFunction_("lists_remove_from_end", [
            "dynamic " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
              "(List my_list, num x) {",
            "  x = my_list.length - x;",
  ...
  Blockly.Dart.lists_setIndex = function (a) {
    ...
    var c = a.getFieldValue("MODE") || "GET",
      d = a.getFieldValue("WHERE") || "FROM_START",
      e =
        Blockly.Dart.valueToCode(a, "LIST", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
        "[]",
      f =
        Blockly.Dart.valueToCode(a, "TO", Blockly.Dart.ORDER_ASSIGNMENT) ||
        "null";
    switch (d) {
      case "FIRST":
      ...
      case "FROM_END":
        ...
        a = b();
        if ("SET" == c)
          return a + (e + "[" + e + ".length - " + d + "] = " + f + ";\n");
        if ("INSERT" == c)
          return (
            a + (e + ".insert(" + e + ".length - " + d + ", " + f + ");\n")
          );
        break;
      case "RANDOM":
        Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;";
        a = b();
        d = Blockly.Dart.variableDB_.getDistinctName(
          "tmp_x",
          Blockly.VARIABLE_CATEGORY_NAME
        );
  ...
  Blockly.Dart.lists_getSublist = function (a) {
    ...
    if (b.match(/^\w+$/) || ("FROM_END" != c && "FROM_START" == d)) {
      ...
      (e = Blockly.Dart.getAdjusted(a, "AT1")),
        (f = Blockly.Dart.getAdjusted(a, "AT2")),
        (a =
          Blockly.Dart.provideFunction_("lists_get_sublist", [
            "List " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Dart.lists_sort = function (a) {
    var b =
        Blockly.Dart.valueToCode(a, "LIST", Blockly.Dart.ORDER_NONE) || "[]",
      c = "1" === a.getFieldValue("DIRECTION") ? 1 : -1;
    a = a.getFieldValue("TYPE");
    return [
      Blockly.Dart.provideFunction_("lists_sort", [
        "List " +
          Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Dart.lists_split = function (a) {
    var b = Blockly.Dart.valueToCode(
        a,
        "INPUT",
        Blockly.Dart.ORDER_UNARY_POSTFIX
      ),
  ...
  Blockly.Dart.controls_if = function (a) {
    var b = 0,
      c = "";
    Blockly.Dart.STATEMENT_PREFIX &&
      (c += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_PREFIX, a));
    do {
      var d =
        Blockly.Dart.valueToCode(a, "IF" + b, Blockly.Dart.ORDER_NONE) ||
        "false";
      var e = Blockly.Dart.statementToCode(a, "DO" + b);
      Blockly.Dart.STATEMENT_SUFFIX &&
        (e =
          Blockly.Dart.prefixLines(
            Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a),
            Blockly.Dart.INDENT
          ) + e);
      c += (0 < b ? "else " : "") + "if (" + d + ") {\n" + e + "}";
      ++b;
    } while (a.getInput("IF" + b));
    if (a.getInput("ELSE") || Blockly.Dart.STATEMENT_SUFFIX)
      (e = Blockly.Dart.statementToCode(a, "ELSE")),
        Blockly.Dart.STATEMENT_SUFFIX &&
          (e =
            Blockly.Dart.prefixLines(
              Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a),
  ...
  Blockly.Dart.logic_operation = function (a) {
    var b = "AND" == a.getFieldValue("OP") ? "&&" : "||",
      c =
        "&&" == b
          ? Blockly.Dart.ORDER_LOGICAL_AND
  ...
  Blockly.Dart.logic_ternary = function (a) {
    var b =
        Blockly.Dart.valueToCode(a, "IF", Blockly.Dart.ORDER_CONDITIONAL) ||
        "false",
      c =
        Blockly.Dart.valueToCode(a, "THEN", Blockly.Dart.ORDER_CONDITIONAL) ||
        "null";
    a =
      Blockly.Dart.valueToCode(a, "ELSE", Blockly.Dart.ORDER_CONDITIONAL) ||
      "null";
  ...
  Blockly.Dart.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
        ...
        : Blockly.Dart.valueToCode(a, "TIMES", Blockly.Dart.ORDER_ASSIGNMENT) ||
          "0",
      c = Blockly.Dart.statementToCode(a, "DO");
    c = Blockly.Dart.addLoopTrap(c, a);
    a = "";
    var d = Blockly.Dart.variableDB_.getDistinctName(
        "count",
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      e = b;
    b.match(/^\w+$/) ||
      Blockly.isNumber(b) ||
      ((e = Blockly.Dart.variableDB_.getDistinctName(
        "repeat_end",
        Blockly.VARIABLE_CATEGORY_NAME
      )),
      (a += "var " + e + " = " + b + ";\n"));
    ...
    var b = "UNTIL" == a.getFieldValue("MODE"),
      c =
        Blockly.Dart.valueToCode(
          a,
          "BOOL",
          b ? Blockly.Dart.ORDER_UNARY_PREFIX : Blockly.Dart.ORDER_NONE
        ) || "false",
  ...
  Blockly.Dart.controls_for = function (a) {
    var b = Blockly.Dart.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      c =
        Blockly.Dart.valueToCode(a, "FROM", Blockly.Dart.ORDER_ASSIGNMENT) ||
        "0",
      d =
        Blockly.Dart.valueToCode(a, "TO", Blockly.Dart.ORDER_ASSIGNMENT) || "0",
      e =
        Blockly.Dart.valueToCode(a, "BY", Blockly.Dart.ORDER_ASSIGNMENT) || "1",
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
      ...
      (a = ""),
        ...
        c.match(/^\w+$/) ||
          Blockly.isNumber(c) ||
          ((g = Blockly.Dart.variableDB_.getDistinctName(
            b + "_start",
            Blockly.VARIABLE_CATEGORY_NAME
          )),
          (a += "var " + g + " = " + c + ";\n")),
  ...
  Blockly.Dart.controls_forEach = function (a) {
    var b = Blockly.Dart.variableDB_.getName(
      ...
      c =
        Blockly.Dart.valueToCode(a, "LIST", Blockly.Dart.ORDER_ASSIGNMENT) ||
        "[]",
      d = Blockly.Dart.statementToCode(a, "DO");
    d = Blockly.Dart.addLoopTrap(d, a);
  ...
  Blockly.Dart.controls_flow_statements = function (a) {
    var b = "";
    Blockly.Dart.STATEMENT_PREFIX &&
      (b += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_PREFIX, a));
    Blockly.Dart.STATEMENT_SUFFIX &&
      (b += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a));
    if (Blockly.Dart.STATEMENT_PREFIX) {
      ...
      c &&
        ...
        (b += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_PREFIX, c));
    }
  ...
  Blockly.Dart.math_number = function (a) {
    ...
    if (Infinity == a) {
      ...
      -Infinity == a
        ? ((a = "-double.infinity"), (b = Blockly.Dart.ORDER_UNARY_PREFIX))
        : (b =
            0 > a
  ...
  Blockly.Dart.math_single = function (a) {
    ...
    if ("NEG" == b)
      return (
        (a =
          Blockly.Dart.valueToCode(a, "NUM", Blockly.Dart.ORDER_UNARY_PREFIX) ||
          "0"),
        "-" == a[0] && (a = " " + a),
        ["-" + a, Blockly.Dart.ORDER_UNARY_PREFIX]
      );
    Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
    a =
      "ABS" == b || "ROUND" == b.substring(0, 5)
        ? Blockly.Dart.valueToCode(
            a,
            "NUM",
            Blockly.Dart.ORDER_UNARY_POSTFIX
    ...
    if ("PRIME" == c)
      return (
        (Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;"),
        [
          Blockly.Dart.provideFunction_("math_isPrime", [
  ...
  Blockly.Dart.math_change = function (a) {
    var b =
      Blockly.Dart.valueToCode(a, "DELTA", Blockly.Dart.ORDER_ADDITIVE) || "0";
    a = Blockly.Dart.variableDB_.getName(
      a.getFieldValue("VAR"),
      Blockly.VARIABLE_CATEGORY_NAME
    );
  ...
  Blockly.Dart.math_on_list = function (a) {
    ...
    switch (b) {
      case "SUM":
        b = Blockly.Dart.provideFunction_("math_sum", [
          "num " +
            Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
            "(List<num> myList) {",
          "  num sumVal = 0;",
      ...
      case "MAX":
        Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;";
        b = Blockly.Dart.provideFunction_("math_max", [
          "num " +
            Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
            "(List<num> myList) {",
          "  if (myList.isEmpty) return null;",
        ...
        break;
      case "AVERAGE":
        b = Blockly.Dart.provideFunction_("math_mean", [
        ...
        break;
      case "MEDIAN":
        b = Blockly.Dart.provideFunction_("math_median", [
          "num " + Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ + "(List myList) {",
      ...
      case "MODE":
        Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;";
        b = Blockly.Dart.provideFunction_("math_modes", [
      ...
      case "STD_DEV":
        Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;";
        b = Blockly.Dart.provideFunction_("math_standard_deviation", [
          "num " + Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ + "(List myList) {",
          "  // First filter list for numbers only.",
      ...
      case "RANDOM":
        Blockly.Dart.definitions_.import_dart_math =
          "import 'dart:math' as Math;";
        b = Blockly.Dart.provideFunction_("math_random_item", [
          "dynamic " +
            Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
            "(List myList) {",
  ...
  Blockly.Dart.math_constrain = function (a) {
    Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
    var b =
        Blockly.Dart.valueToCode(a, "VALUE", Blockly.Dart.ORDER_NONE) || "0",
      c = Blockly.Dart.valueToCode(a, "LOW", Blockly.Dart.ORDER_NONE) || "0";
    a =
      Blockly.Dart.valueToCode(a, "HIGH", Blockly.Dart.ORDER_NONE) ||
      "double.infinity";
    return [
  ...
  Blockly.Dart.math_random_int = function (a) {
    ...
    return [
      Blockly.Dart.provideFunction_("math_random_int", [
  ...
  Blockly.Dart.math_atan2 = function (a) {
    ...
    return [
      "Math.atan2(" +
        (Blockly.Dart.valueToCode(a, "Y", Blockly.Dart.ORDER_NONE) || "0") +
        ", " +
        b +
        ") / Math.pi * 180",
      Blockly.Dart.ORDER_MULTIPLICATIVE,
  ...
  Blockly.Dart.procedures_defreturn = function (a) {
    ...
    Blockly.Dart.STATEMENT_PREFIX &&
      (c += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_PREFIX, a));
    Blockly.Dart.STATEMENT_SUFFIX &&
      (c += Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a));
    c && (c = Blockly.Dart.prefixLines(c, Blockly.Dart.INDENT));
    var d = "";
    Blockly.Dart.INFINITE_LOOP_TRAP &&
      (d = Blockly.Dart.prefixLines(
        Blockly.Dart.injectId(Blockly.Dart.INFINITE_LOOP_TRAP, a),
        Blockly.Dart.INDENT
      ));
    ...
    for (
      var m = f ? "dynamic" : "void", k = [], l = a.getVars(), h = 0;
      h < l.length;
      h++
    )
      k[h] = Blockly.Dart.variableDB_.getName(
        l[h],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    c = m + " " + b + "(" + k.join(", ") + ") {\n" + c + d + e + g + f + "}";
  ...
  Blockly.Dart.procedures_callreturn = function (a) {
    for (
      ...
      c[e] =
        Blockly.Dart.valueToCode(a, "ARG" + e, Blockly.Dart.ORDER_NONE) ||
        "null";
  ...
  Blockly.Dart.procedures_ifreturn = function (a) {
    var b =
      "if (" +
      (Blockly.Dart.valueToCode(a, "CONDITION", Blockly.Dart.ORDER_NONE) ||
        "false") +
      ") {\n";
    Blockly.Dart.STATEMENT_SUFFIX &&
      (b += Blockly.Dart.prefixLines(
        Blockly.Dart.injectId(Blockly.Dart.STATEMENT_SUFFIX, a),
        Blockly.Dart.INDENT
      ));
    a.hasReturnValue_
      ? ((a =
          Blockly.Dart.valueToCode(a, "VALUE", Blockly.Dart.ORDER_NONE) ||
          "null"),
        (b += Blockly.Dart.INDENT + "return " + a + ";\n"))
  ...
  Blockly.Dart.text = function (a) {
    return [
      Blockly.Dart.quote_(a.getFieldValue("TEXT")),
      Blockly.Dart.ORDER_ATOMIC,
    ];
  };
  Blockly.Dart.text_multiline = function (a) {
    return [
      Blockly.Dart.multiline_quote_(a.getFieldValue("TEXT")),
      Blockly.Dart.ORDER_ATOMIC,
    ];
  };
  ...
  Blockly.Dart.text_charAt = function (a) {
    ...
    switch (b) {
      ...
      case "FROM_START":
        return (
          (a = Blockly.Dart.getAdjusted(a, "AT")),
          [c + "[" + a + "]", Blockly.Dart.ORDER_UNARY_POSTFIX]
        );
      case "LAST":
      case "FROM_END":
        return (
          (a = Blockly.Dart.getAdjusted(a, "AT", 1)),
          (b = Blockly.Dart.provideFunction_("text_get_from_end", [
            "String " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
              "(String text, num x) {",
      ...
      case "RANDOM":
        return (
          (Blockly.Dart.definitions_.import_dart_math =
            "import 'dart:math' as Math;"),
          (b = Blockly.Dart.provideFunction_("text_random_letter", [
            "String " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
              "(String text) {",
          ...
          [b + "(" + c + ")", Blockly.Dart.ORDER_UNARY_POSTFIX]
        );
    }
  ...
  Blockly.Dart.text_getSubstring = function (a) {
    ...
    if ("FIRST" == c && "LAST" == d) a = b;
      ...
      (e = Blockly.Dart.getAdjusted(a, "AT1")),
        (f = Blockly.Dart.getAdjusted(a, "AT2")),
        (a =
          Blockly.Dart.provideFunction_("text_get_substring", [
            "String " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Dart.text_changeCase = function (a) {
    ...
    a =
      Blockly.Dart.valueToCode(
        a,
        "TEXT",
        b ? Blockly.Dart.ORDER_UNARY_POSTFIX : Blockly.Dart.ORDER_NONE
      ) || "''";
    return [
      b
        ? a + b
        : Blockly.Dart.provideFunction_("text_toTitleCase", [
            "String " +
              Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
              "(String str) {",
  ...
  Blockly.Dart.text_trim = function (a) {
    ...
    return [
      (Blockly.Dart.valueToCode(a, "TEXT", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
        "''") + b,
      Blockly.Dart.ORDER_UNARY_POSTFIX,
    ];
  };
  Blockly.Dart.text_print = function (a) {
    return (
      "print(" +
      (Blockly.Dart.valueToCode(a, "TEXT", Blockly.Dart.ORDER_NONE) || "''") +
      ");\n"
    );
  };
    ...
    var b =
      ...
      (a.getField("TEXT")
        ...
        : Blockly.Dart.valueToCode(a, "TEXT", Blockly.Dart.ORDER_NONE) ||
          "''") +
      ", '')";
    "NUMBER" == a.getFieldValue("TYPE") &&
      ((Blockly.Dart.definitions_.import_dart_math =
        "import 'dart:math' as Math;"),
      (b = "Math.parseDouble(" + b + ")"));
    return [b, Blockly.Dart.ORDER_UNARY_POSTFIX];
  };
  ...
  Blockly.Dart.text_count = function (a) {
    ...
    return [
      Blockly.Dart.provideFunction_("text_count", [
        "int " +
          Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Dart.variables_set = function (a) {
    var b =
      Blockly.Dart.valueToCode(a, "VALUE", Blockly.Dart.ORDER_ASSIGNMENT) ||
      "0";
    return (
      Blockly.Dart.variableDB_.getName(
        a.getFieldValue("VAR"),
