...
(function (root, factory) {
  ...
  (function (a) {
    ...
    Blockly.utils.userAgent.CHROME =
      (b("Chrome") || b("CriOS")) && !Blockly.utils.userAgent.EDGE;
    Blockly.utils.userAgent.WEBKIT =
      b("WebKit") && !Blockly.utils.userAgent.EDGE;
  ...
  Blockly.utils.tokenizeInterpolation_ = function (a, b) {
    ...
    for (var f = null, g = 0; g < d.length; g++) {
      ...
      0 == e
        ? "%" == h
          ? ((h = a.join("")) && c.push(h), (a.length = 0), (e = 1))
          : a.push(h)
        : 1 == e
        ? "%" == h
          ? (a.push(h), (e = 0))
          : b && "0" <= h && "9" >= h
          ? ((e = 2), (f = h), (h = a.join("")) && c.push(h), (a.length = 0))
          : "{" == h
          ? (e = 3)
          : (a.push("%", h), (e = 0))
        : 2 == e
        ...
        : 3 == e &&
          ("" == h
            ...
            : ((e = a.join("")),
              /[A-Z]\w*/i.test(e)
                ? ((h = e.toUpperCase()),
                  (h = Blockly.utils.string.startsWith(h, "BKY_")
                    ? h.substring(4)
                    : null) && h in Blockly.Msg
                    ? ((e = Blockly.Msg[h]),
                      "string" == typeof e
    ...
    for (g = a.length = 0; g < c.length; ++g)
      "string" == typeof c[g]
        ? a.push(c[g])
        : ((h = a.join("")) && b.push(h), (a.length = 0), b.push(c[g]));
    (h = a.join("")) && b.push(h);
    a.length = 0;
    return b;
  };
  ...
  Blockly.utils.getBlockTypeCounts = function (a, b) {
    ...
    b &&
      (a = a.getNextBlock()) &&
      ((a = d.indexOf(a)), d.splice(a, d.length - a));
  ...
  Blockly.utils.parseBlockColour = function (a) {
    var b =
        "string" == typeof a ? Blockly.utils.replaceMessageReferences(a) : a,
      c = Number(b);
    ...
    for (var c = [], d = Object.create(null), e = 0, f; (f = a[e]); e++)
      if (!f.isNull()) {
        ...
        if (!h) (d[g] = { event: f, index: e }), c.push(f);
          ...
          f.type == Blockly.Events.CHANGE &&
          f.element == k.element &&
          f.name == k.name
        )
          k.newValue = f.newValue;
        else if (
          f.type != Blockly.Events.UI ||
          "click" != f.element ||
          ("commentOpen" != k.element &&
            "mutatorOpen" != k.element &&
            "warningOpen" != k.element)
        )
  ...
  Blockly.utils.object.deepMerge = function (a, b) {
    for (var c in b)
      a[c] =
        null != b[c] && "object" === typeof b[c]
          ? Blockly.utils.object.deepMerge(a[c] || Object.create(null), b[c])
          : b[c];
    return a;
  };
  ...
  Blockly.utils.dom.getTextWidth = function (a) {
    ...
    if (
      ...
      (c = Blockly.utils.dom.cacheWidths_[b])
    )
      return c;
    try {
      c =
  ...
  Blockly.utils.dom.getFastTextWidthWithSizeString = function (a, b, c, d) {
    ...
    if (
      Blockly.utils.dom.cacheWidths_ &&
      (f = Blockly.utils.dom.cacheWidths_[a])
    )
      return f;
  ...
  Blockly.Component.prototype.addChildAt = function (a, b, c) {
    ...
    a.inDocument_ && this.inDocument_ && a.getParent() == this
      ...
      : this.inDocument_ &&
        ...
        a.element_.parentNode.nodeType ==
  ...
  Blockly.Css.setCursor = function (a) {
    console.warn(
      "Deprecated call to Blockly.Css.setCursor. See issue #981 for context"
    );
  };
  Blockly.Css.CONTENT = [
    ".blocklySvg {",
  ...
  Blockly.DropDownDiv.showPositionedByBlock = function (a, b, c, d) {
    return Blockly.DropDownDiv.showPositionedByRect_(
      Blockly.DropDownDiv.getScaledBboxOfBlock_(b),
      a,
      c,
      d
    );
  ...
  Blockly.DropDownDiv.showPositionedByField = function (a, b, c) {
    ...
    return Blockly.DropDownDiv.showPositionedByRect_(
      Blockly.DropDownDiv.getScaledBboxOfField_(a),
      a,
      b,
      c
    );
  ...
  Blockly.DropDownDiv.getBoundsInfo_ = function () {
    var a = Blockly.utils.style.getPageOffset(
  ...
  Blockly.DropDownDiv.getPositionMetrics_ = function (a, b, c, d) {
    ...
    return b + f.height < e.bottom
      ? Blockly.DropDownDiv.getPositionBelowMetrics_(a, b, e, f)
      : d - f.height > e.top
      ? Blockly.DropDownDiv.getPositionAboveMetrics_(c, d, e, f)
      : b + f.height < document.documentElement.clientHeight
      ? Blockly.DropDownDiv.getPositionBelowMetrics_(a, b, e, f)
      : d - f.height > document.documentElement.clientTop
      ? Blockly.DropDownDiv.getPositionAboveMetrics_(c, d, e, f)
      : Blockly.DropDownDiv.getPositionTopOfPageMetrics_(a, e, f);
  };
  ...
  Blockly.registry.register = function (a, b, c) {
    if (
      (!(a instanceof Blockly.registry.Type) && "string" != typeof a) ||
      "" == String(a).trim()
    )
      throw Error(
        'Invalid type "' +
    ...
    if ("string" != typeof b || "" == b.trim())
      throw Error(
        'Invalid name "' + b + '". The name must be a non-empty string.'
      );
    b = b.toLowerCase();
    if (!c) throw Error("Can not register a null value");
    var d = Blockly.registry.typeMap_[a];
    d || (d = Blockly.registry.typeMap_[a] = {});
  ...
  Blockly.registry.unregister = function (a, b) {
    ...
    c
      ? c[b]
        ? delete Blockly.registry.typeMap_[a][b]
        : console.warn('No name "' + b + '" with type "' + a + '" found')
  ...
  Blockly.Theme.prototype.getComponentStyle = function (a) {
    return (a = this.componentStyles[a]) &&
  ...
  Blockly.Theme.defineTheme = function (a, b) {
    ...
    d &&
      ("string" == typeof d &&
        (d = Blockly.registry.getObject(Blockly.registry.Type.THEME, d)),
      d instanceof Blockly.Theme &&
        (Blockly.utils.object.deepMerge(c, d), (c.name = a)));
  ...
  Blockly.user.keyMap.getKeyByAction = function (a) {
    for (
      var b = Object.keys(Blockly.user.keyMap.map_), c = 0, d;
      (d = b[c]);
      c++
    )
  ...
  Blockly.user.keyMap.createDefaultKeyMap = function () {
    var a = {},
      ...
      c = Blockly.user.keyMap.createSerializedKey(Blockly.utils.KeyCodes.W, [
        Blockly.user.keyMap.modifierKeys.SHIFT,
      ]),
      d = Blockly.user.keyMap.createSerializedKey(Blockly.utils.KeyCodes.A, [
        Blockly.user.keyMap.modifierKeys.SHIFT,
      ]),
      e = Blockly.user.keyMap.createSerializedKey(Blockly.utils.KeyCodes.S, [
        Blockly.user.keyMap.modifierKeys.SHIFT,
      ]),
      f = Blockly.user.keyMap.createSerializedKey(Blockly.utils.KeyCodes.D, [
        Blockly.user.keyMap.modifierKeys.SHIFT,
      ]);
  ...
  Blockly.utils.toolbox.convertToolboxToJSON = function (a) {
    return a
      ? Array.isArray(a) && a.length && !a[0].nodeType
        ? (Blockly.utils.toolbox.hasCategories(a) &&
            console.warn(
              "Due to some performance issues, defining a toolbox usingJSON is not ready yet. Please define your toolbox using xml."
            ),
          a)
        : Blockly.utils.toolbox.toolboxXmlToJson_(a)
      : null;
  };
  Blockly.utils.toolbox.toolboxXmlToJson_ = function (a) {
    var b = [],
      c = a.childNodes;
    c || (c = a);
    a = 0;
    for (var d; (d = c[a]); a++)
      if (d.tagName) {
        ...
        "BLOCK" == f
          ? (e.blockxml = d)
          : "CATEGORY" == f &&
            (e.contents = Blockly.utils.toolbox.toolboxXmlToJson_(d));
        for (f = 0; f < d.attributes.length; f++) {
          var g = d.attributes[f];
          e[g.nodeName] = g.value;
        }
        b.push(e);
      }
    return b;
  ...
  Blockly.utils.toolbox.hasCategories = function (a) {
    return Array.isArray(a)
      ? !(!a.length || "CATEGORY" != a[0].kind.toUpperCase())
      : !(!a || !a.getElementsByTagName("category").length);
  };
  Blockly.utils.xml = {};
  ...
  Blockly.Xml.blockToDomWithXY = function (a, b) {
    if (a.isInsertionMarker() && ((a = a.getChildren(!1)[0]), !a))
  ...
  Blockly.Xml.blockToDom = function (a, b) {
    ...
    for (d = 0; (e = a.inputList[d]); d++) {
      ...
      if (e.type != Blockly.DUMMY_INPUT) {
        ...
        !g ||
          (k && k.isShadow()) ||
          h.appendChild(Blockly.Xml.cloneShadow_(g, b));
        k &&
          ((g = Blockly.Xml.blockToDom(k, b)),
          g.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE &&
            (h.appendChild(g), (f = !1)));
  ...
  Blockly.Xml.cloneShadow_ = function (a, b) {
    for (var c = (a = a.cloneNode(!0)), d; c; )
      if (
        (b && "shadow" == c.nodeName && c.removeAttribute("id"), c.firstChild)
      )
        c = c.firstChild;
      else {
        for (; c && !c.nextSibling; )
          (d = c),
            (c = c.parentNode),
            d.nodeType == Blockly.utils.dom.NodeType.TEXT_NODE &&
              "" == d.data.trim() &&
              c.firstChild != d &&
  ...
  Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    ...
    for (var g; (g = a.childNodes[e]); e++)
      if (g.nodeType != Blockly.utils.dom.NodeType.TEXT_NODE) {
        var h = (f = null);
        var k = 0;
        for (var l; (l = g.childNodes[k]); k++)
          l.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE &&
        ...
        switch (g.nodeName.toLowerCase()) {
          ...
          case "comment":
            ...
            isNaN(g) ||
              isNaN(k) ||
              (c.commentModel.size = new Blockly.utils.Size(g, k));
            h &&
              c.getCommentIcon &&
              !c.isInFlyout &&
              setTimeout(function () {
          ...
          case "statement":
            ...
            if (!k) {
              console.warn(
                "Ignoring non-existent input " + l + " in block " + d
              );
              break;
            }
  ...
  Blockly.Options = function (a) {
    ...
    if (b)
      ...
      c = a.toolbox;
      Array.isArray(c) || (c = Blockly.Options.parseToolboxTree(c || null));
      c = Blockly.utils.toolbox.convertToolboxToJSON(c);
  ...
  Blockly.Options.parseThemeOptions_ = function (a) {
    ...
    return "string" == typeof a
      ? Blockly.registry.getObject(Blockly.registry.Type.THEME, a)
      : a instanceof Blockly.Theme
      ? a
      : Blockly.Theme.defineTheme(
          a.name || "builtin" + Blockly.utils.IdGenerator.getNextUniqueId(),
          a
        );
  };
  ...
  Blockly.Scrollbar.prototype.setPosition = function (a, b) {
    ...
    Blockly.utils.dom.setCssTransform(
      this.outerSvg_,
      "translate(" +
        (this.position.x + this.origin_.x) +
        "px," +
        (this.position.y + this.origin_.y) +
        "px)"
    );
  };
  ...
  Blockly.Scrollbar.prototype.resizeContentHorizontal = function (a) {
    ...
    if (-Infinity == this.ratio || Infinity == this.ratio || isNaN(this.ratio))
      this.ratio = 0;
    this.setHandleLength_(Math.max(0, a.viewWidth * this.ratio));
    this.setHandlePosition(
      this.constrainHandle_((a.viewLeft - a.contentLeft) * this.ratio)
    );
  };
  ...
  Blockly.Tooltip.createDom = function () {
    Blockly.Tooltip.DIV ||
      ...
      (Blockly.parentContainer || document.body).appendChild(
        Blockly.Tooltip.DIV
      ));
  };
  Blockly.Tooltip.bindMouseEvents = function (a) {
    a.mouseOverWrapper_ = Blockly.bindEvent_(
      a,
      "mouseover",
      null,
      Blockly.Tooltip.onMouseOver_
    );
    a.mouseOutWrapper_ = Blockly.bindEvent_(
      a,
      "mouseout",
      null,
  ...
  Blockly.Tooltip.unbindMouseEvents = function (a) {
    a &&
      (Blockly.unbindEvent_(a.mouseOverWrapper_),
      Blockly.unbindEvent_(a.mouseOutWrapper_),
    ...
    if (
      ...
      a
        ...
        : d + Blockly.Tooltip.DIV.offsetWidth >
          ...
          (d =
            b - Blockly.Tooltip.DIV.offsetWidth - 2 * Blockly.Tooltip.MARGINS);
  ...
  Blockly.ASTNode.createWorkspaceNode = function (a, b) {
    return b && a
      ? new Blockly.ASTNode(Blockly.ASTNode.types.WORKSPACE, a, {
          wsCoordinate: b,
        })
      : null;
  };
    ...
    for (var d = 0, e; (e = b[d]); d++)
      if (c.id == e.id)
        return (
          ...
          -1 == a || a == b.length
            ? null
            : Blockly.ASTNode.createStackNode(b[a])
        );
  ...
  Blockly.ASTNode.prototype.prev = function () {
    switch (this.type_) {
      ...
      case Blockly.ASTNode.types.BLOCK:
        var a = this.location_;
        return Blockly.ASTNode.createConnectionNode(
          a.previousConnection || a.outputConnection
        );
      case Blockly.ASTNode.types.PREVIOUS:
        a = this.location_;
    ...
    switch (this.type_) {
      case Blockly.ASTNode.types.STACK:
        ...
        b = new Blockly.utils.Coordinate(
          b.x,
          b.y + Blockly.ASTNode.DEFAULT_OFFSET_Y
        );
        return Blockly.ASTNode.createWorkspaceNode(a.workspace, b);
      case Blockly.ASTNode.types.OUTPUT:
        return (
          (a = this.location_),
          (b = a.targetConnection)
            ? Blockly.ASTNode.createConnectionNode(b)
            : Blockly.ASTNode.createStackNode(a.getSourceBlock())
        );
      case Blockly.ASTNode.types.FIELD:
      ...
      case Blockly.ASTNode.types.PREVIOUS:
        return (
          (a = this.location_), this.getOutAstNodeForBlock_(a.getSourceBlock())
        );
      case Blockly.ASTNode.types.NEXT:
        return (
          (a = this.location_), this.getOutAstNodeForBlock_(a.getSourceBlock())
      ...
      if (e.isShadow())
        ...
        for (g = d; g.nextConnection; ) {
          ...
          if (h && !h.isShadow()) g = h;
            ...
            e.previousConnection.checkType(g.nextConnection) &&
  ...
  Blockly.Connection.prototype.canConnectToPrevious_ = function (a) {
    if (this.targetConnection || -1 != Blockly.draggingConnections.indexOf(a))
      return !1;
  ...
  Blockly.Connection.prototype.isConnectionAllowed = function (a) {
    if (
      ...
      this.canConnectWithReason(a) != Blockly.Connection.CAN_CONNECT
    )
      return !1;
    switch (a.type) {
  ...
  Blockly.Connection.singleConnection_ = function (a, b) {
    for (var c = null, d = 0; d < a.inputList.length; d++) {
      ...
      if (
        e &&
        e.type == Blockly.INPUT_VALUE &&
        b.outputConnection.checkType(e)
      ) {
        if (c) return null;
        c = e;
      }
  ...
  Blockly.fieldRegistry.fromJson = function (a) {
    var b = Blockly.registry.getClass(Blockly.registry.Type.FIELD, a.type);
    return b
      ? b.fromJson(a)
      : (console.warn(
  ...
  Blockly.InsertionMarkerManager.prototype.shouldDelete_ = function (a, b) {
    ...
    return (
      !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable() && !a
    );
  };
  Blockly.InsertionMarkerManager.prototype.maybeShowPreview_ = function (a) {
    if (!this.wouldDeleteBlock_) {
      ...
      a = a.local;
      b &&
        (b == this.closestConnection_ || b.getSourceBlock().isInsertionMarker()
  ...
  Blockly.InsertionMarkerManager.prototype.showPreview_ = function () {
    ...
    switch (
      b.getConnectionPreviewMethod(a, this.localConnection_, this.topBlock_)
    ) {
  ...
  Blockly.InsertionMarkerManager.prototype.hidePreview_ = function () {
    ...
    this.fadedBlock_
      ...
      : this.highlightedBlock_
      ? this.hideInsertionInputOutline_()
      : this.markerConnection_ && this.hideInsertionMarker_();
  };
  ...
  Blockly.BlockDragger.prototype.startBlockDrag = function (a, b) {
    ...
    (a = this.workspace_.getToolbox()) &&
      "function" == typeof a.addStyle &&
      ((b = this.draggingBlock_.isDeletable()
        ? "blocklyToolboxDelete"
        : "blocklyToolboxGrab"),
      a.addStyle(b));
  };
  Blockly.BlockDragger.prototype.fireDragStartEvent_ = function () {
    var a = new Blockly.Events.Ui(
      this.draggingBlock_,
      "dragStart",
      null,
  ...
  Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_ = function () {
    ...
    this.wouldDeleteBlock_
      ? (this.draggingBlock_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(!0))
      : (this.draggingBlock_.setDeleteStyle(!1), a && a.setOpen(!1));
  };
      ...
      1 < d.length
        ? ((c = Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace(
          ...
          Blockly.confirm(c, function (a) {
            a && b && f.deleteVariableInternal(b, d);
          }))
  ...
  Blockly.VariableMap.prototype.getVariableTypes = function (a) {
    ...
    a &&
      ...
      Blockly.utils.object.mixin(b, a.getPotentialVariableMap().variableMap_);
    a = Object.keys(b);
    b = !1;
  ...
  Blockly.Workspace.prototype.sortObjects_ = function (a, b) {
    ...
    return (
      a.y +
      Blockly.Workspace.prototype.sortObjects_.offset * a.x -
      (b.y + Blockly.Workspace.prototype.sortObjects_.offset * b.x)
    );
  };
  ...
  Blockly.Workspace.prototype.removeTypedBlock = function (a) {
    this.typedBlocksDB_[a.type].splice(
      this.typedBlocksDB_[a.type].indexOf(a),
      1
    );
  ...
  Blockly.Workspace.prototype.remainingCapacityOfType = function (a) {
    return this.options.maxInstances
      ? (void 0 !== this.options.maxInstances[a]
          ? this.options.maxInstances[a]
          : Infinity) - this.getBlocksByType(a, !1).length
      : Infinity;
  };
    ...
    return Math.max(
      ...
      Math.min(
        ...
        ((Math.min(c + this.width_, b.viewLeft + b.viewWidth) -
          ...
          (Math.min(a + this.height_, b.viewTop + b.viewHeight) -
            Math.max(a, b.viewTop))) /
  ...
  Blockly.Events.CommentCreateDeleteHelper = function (a, b) {
    ...
    b
      ? ((b = Blockly.utils.xml.createElement("xml")),
        b.appendChild(a.xml),
        Blockly.Xml.domToWorkspace(b, c))
  ...
  Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function () {
    ...
    this.wouldDeleteBubble_
      ? (this.draggingBubble_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(!0))
      : (this.draggingBubble_.setDeleteStyle(!1), a && a.setOpen(!1));
  };
  Blockly.BubbleDragger.prototype.endBubbleDrag = function (a, b) {
    ...
    (a = this.workspace_.getToolbox()) &&
      "function" == typeof a.removeStyle &&
      ((b = this.draggingBubble_.isDeletable()
        ? "blocklyToolboxDelete"
        : "blocklyToolboxGrab"),
      a.removeStyle(b));
    Blockly.Events.setGroup(!1);
  ...
  Blockly.navigation.focusFlyout_ = function () {
    ...
    a &&
      a.getWorkspace() &&
      ((a = a.getWorkspace().getTopBlocks(!0)),
      0 < a.length &&
        ((a = a[0]),
  ...
  Blockly.navigation.focusWorkspace_ = function () {
    ...
    Blockly.navigation.currentState_ = Blockly.navigation.STATE_WS;
    0 < d.length
      ? b.setCurNode(Blockly.ASTNode.createTopNode(d[0]))
  ...
  Blockly.navigation.getFlyoutCursor_ = function () {
    var a = Blockly.navigation.getNavigationWorkspace(),
      b = null;
    a.rendered &&
      (b = (a = (b = a.getToolbox()) ? b.getFlyout() : a.getFlyout())
        ? a.getWorkspace().getCursor()
        : null);
    return b;
  };
    ...
    if (b && b.isVisible()) {
      ...
      c.isEnabled()
        ? ((b = b.createBlock(c)),
          ...
          a.getCursor().setCurNode(Blockly.ASTNode.createTopNode(b)),
  ...
  Blockly.navigation.resetFlyout_ = function (a) {
    Blockly.navigation.getFlyoutCursor_() &&
      ...
      a && Blockly.navigation.getNavigationWorkspace().getFlyout().hide());
  };
  ...
  Blockly.navigation.moveAndConnect_ = function (a, b) {
    if (!a || !b) return !1;
    var c = a.getSourceBlock();
    return b.canConnectWithReason(a) == Blockly.Connection.CAN_CONNECT
      ...
      c.isConnected()
        ? ((b = c.isSuperior() ? c : c.targetConnection),
          ...
          c.getSourceBlock().isShadow()
            ...
            : (b.disconnect(),
              c.bumpAwayFrom(b),
              b.getSourceBlock().getRootBlock().bringToFront(),
  ...
  Blockly.navigation.enableKeyboardAccessibility = function () {
    var a = Blockly.navigation.getNavigationWorkspace();
    a.keyboardAccessibilityMode ||
      ((a.keyboardAccessibilityMode = !0),
      Blockly.navigation.focusWorkspace_());
  };
  Blockly.navigation.disableKeyboardAccessibility = function () {
    var a = Blockly.navigation.getNavigationWorkspace();
    a.keyboardAccessibilityMode &&
      ((a.keyboardAccessibilityMode = !1),
      a.getCursor().hide(),
  ...
  Blockly.navigation.flyoutOnAction_ = function (a) {
    var b = Blockly.navigation.getNavigationWorkspace(),
      c = b.getToolbox();
    if ((b = c ? c.getFlyout() : b.getFlyout()) && b.onBlocklyAction(a))
      return !0;
    switch (a.name) {
  ...
  Blockly.navigation.toolboxOnAction_ = function (a) {
    var b = Blockly.navigation.getNavigationWorkspace(),
      c = b.getToolbox();
    return c && "function" == typeof c.onBlocklyAction && c.onBlocklyAction(a)
      ? !0
      : a.name === Blockly.navigation.actionNames.TOOLBOX
      ? (b.getToolbox()
          ? Blockly.navigation.focusToolbox_()
          : Blockly.navigation.focusFlyout_(),
        !0)
      : a.name === Blockly.navigation.actionNames.IN
      ? (Blockly.navigation.focusFlyout_(), !0)
      : a.name === Blockly.navigation.actionNames.EXIT
      ? (Blockly.navigation.focusWorkspace_(), !0)
      : !1;
  };
  Blockly.navigation.moveWSCursor_ = function (a, b) {
    var c = Blockly.navigation.getNavigationWorkspace(),
      d = c.getCursor(),
      e = c.getCursor().getCurNode();
    ...
    d.setCurNode(
      Blockly.ASTNode.createWorkspaceNode(
        c,
        new Blockly.utils.Coordinate(
          a * Blockly.navigation.WS_MOVE_DISTANCE + e.x,
          b * Blockly.navigation.WS_MOVE_DISTANCE + e.y
        )
      )
    );
    return !0;
  ...
  Blockly.navigation.workspaceOnAction_ = function (a) {
    if (
      Blockly.navigation.getNavigationWorkspace().getCursor().onBlocklyAction(a)
    )
      return !0;
    switch (a.name) {
  ...
  Blockly.navigation.handleEnterForWS_ = function () {
    var a = Blockly.navigation
        .getNavigationWorkspace()
        .getCursor()
        .getCurNode(),
      b = a.getType();
    b == Blockly.ASTNode.types.FIELD
      ? a.getLocation().showEditor()
  ...
  Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function () {
    return this.targetBlock_ &&
      this.flyout_.isBlockCreatable_(this.targetBlock_)
  ...
  Blockly.Gesture.prototype.handleRightClick = function (a) {
    this.targetBlock_
      ? (this.bringBlockToFront_(),
        Blockly.hideChaff(!!this.flyout_),
        this.targetBlock_.showContextMenu(a))
      : this.startBubble_
      ? this.startBubble_.showContextMenu(a)
      : this.startWorkspace_ &&
        !this.flyout_ &&
        (Blockly.hideChaff(), this.startWorkspace_.showContextMenu(a));
    a.preventDefault();
    a.stopPropagation();
    this.dispose();
  };
  ...
  Blockly.Gesture.prototype.fireWorkspaceClick_ = function (a) {
    var b = new Blockly.Events.Ui(null, "workspaceClick", null, null);
    b.workspaceId = a.id;
  ...
  Blockly.Gesture.prototype.setTargetBlock_ = function (a) {
    a.isShadow()
      ? this.setTargetBlock_(a.getParent())
      : (this.targetBlock_ = a);
  };
  ...
  Blockly.Field.prototype.updateSize_ = function (a) {
    ...
    var c = 2 * a,
      ...
      e = 0;
    this.textElement_ &&
      ((e = Blockly.utils.dom.getFastTextWidth(
        this.textElement_,
        b.FIELD_TEXT_FONTSIZE,
        b.FIELD_TEXT_FONTWEIGHT,
        b.FIELD_TEXT_FONTFAMILY
      )),
      (c += e));
  ...
  Blockly.Field.prototype.positionTextElement_ = function (a, b) {
    if (this.textElement_) {
      ...
      this.textElement_.setAttribute(
        "x",
        this.sourceBlock_.RTL ? this.size_.width - b - a : a
      );
      this.textElement_.setAttribute(
        "y",
        c.FIELD_TEXT_BASELINE_CENTER
          ? d
          : d - c.FIELD_TEXT_HEIGHT / 2 + c.FIELD_TEXT_BASELINE
      );
    }
  };
  ...
  Blockly.Field.prototype.setTooltip = function (a) {
    ...
    b
      ? (b.tooltip = a || "" === a ? a : this.sourceBlock_)
      : (this.tooltip_ = a);
  };
  ...
  Blockly.Field.prototype.updateMarkers_ = function () {
    ...
    a.keyboardAccessibilityMode &&
      this.markerSvg_ &&
      a.getMarker(Blockly.navigation.MARKER_NAME).draw();
  };
  ...
  Blockly.Input.prototype.setVisible = function (a) {
    ...
    this.connection &&
      ...
      (c = this.connection.targetBlock())) &&
      (c.getSvgRoot().style.display = a ? "block" : "none");
    return b;
  };
  ...
  Blockly.Input.prototype.setAlign = function (a) {
    this.align = a;
    this.sourceBlock_.rendered &&
      ((this.sourceBlock_ = this.sourceBlock_), this.sourceBlock_.render());
    return this;
  };
  ...
  Blockly.Block.prototype.toString = function (a, b) {
    function c(a) {
      ...
      return !!b && (-1 != b.indexOf("Boolean") || -1 != b.indexOf("Number"));
    }
    function d() {
      g &&
        g.getType() == h.getType() &&
        g.getLocation() == h.getLocation() &&
        (g = null);
    }
    var e = [];
    b = b || "?";
    ...
    for (var g = Blockly.ASTNode.createBlockNode(this), h = g; g; ) {
      switch (g.getType()) {
        ...
        case Blockly.ASTNode.types.FIELD:
          (k = g.getLocation()),
            k.name != Blockly.Block.COLLAPSED_FIELD_NAME && e.push(k.getText());
      }
      k = g;
      g = k.in() || k.next();
      if (!g) {
        ...
        for (d(); g && !g.next(); )
          (g = g.out()),
            d(),
            g &&
              g.getType() == Blockly.ASTNode.types.INPUT &&
              c(g.getLocation()) &&
              e.push(")");
        g && (g = g.next());
      }
    ...
    for (f = e.length; b < f; b++)
      "(" == e[b - 2] &&
        ")" == e[b] &&
        ((e[b - 2] = e[b - 1]), e.splice(b - 1, 2), (f -= 2));
    e =
      e
        .join(" ")
        .replace(/(\() | (\))/gim, "$1$2")
  ...
  Blockly.Block.prototype.interpolate_ = function (a, b, c, d) {
    ...
    for (var h = 0; h < e.length; h++) {
      ...
      if ("number" == typeof k) {
        if (0 >= k || k > b.length)
          throw Error(
            'Block "' + this.type + '": Message index %' + k + " out of range."
          );
        if (f[k])
          throw Error(
            'Block "' + this.type + '": Message index %' + k + " duplicated."
          );
        f[k] = !0;
        g++;
        a.push(b[k - 1]);
    ...
    a.length &&
      ...
      ((h = { type: "input_dummy" }), c && (h.align = c), a.push(h));
    c = {
    ...
    for (h = 0; h < a.length; h++)
      if (((f = a[h]), "string" == typeof f)) b.push([f, void 0]);
          ...
          if (((k = !1), "string" == typeof f)) g = new Blockly.FieldLabel(f);
            ...
            switch (f.type) {
              ...
              case "input_statement":
                e = this.appendStatementInput(f.name);
                break;
              case "input_dummy":
                e = this.appendDummyInput(f.name);
                break;
              default:
                (g = Blockly.fieldRegistry.fromJson(f)),
                  !g && f.alt && ((f = f.alt), (k = !0));
            }
        while (k);
        if (g) b.push([g, f.name]);
          ...
          f.align &&
            ((g = c[f.align.toUpperCase()]),
            void 0 === g
              ? console.warn(d + "Illegal align value: ", f.align)
              : e.setAlign(g));
  ...
  Blockly.Menu.prototype.handleMouseOver_ = function (a) {
    (a = this.getMenuItem_(a.target)) &&
      (a.isEnabled()
        ? this.highlightedItem_ != a && this.setHighlighted(a)
  ...
  Blockly.Menu.prototype.handleKeyEvent_ = function (a) {
    if (
      ...
      !(a.shiftKey || a.ctrlKey || a.metaKey || a.altKey)
    ) {
      var b = this.highlightedItem_;
      switch (a.keyCode) {
  ...
  Blockly.MenuItem.prototype.createDom = function () {
    ...
    c = this.content_;
    "string" == typeof this.content_ &&
      (c = document.createTextNode(this.content_));
    b.appendChild(c);
    a.appendChild(b);
  ...
  Blockly.MenuItem.prototype.setHighlighted = function (a) {
    ...
    b &&
      this.isEnabled() &&
      (a
        ? (Blockly.utils.dom.addClass(b, "blocklyMenuItemHighlight"),
          Blockly.utils.dom.addClass(b, "goog-menuitem-highlight"))
        : (Blockly.utils.dom.removeClass(b, "blocklyMenuItemHighlight"),
  ...
  Blockly.ContextMenu.dispose = function () {
    Blockly.ContextMenu.menu_ &&
      (Blockly.ContextMenu.menu_.dispose(), (Blockly.ContextMenu.menu_ = null));
  };
  ...
  Blockly.RenderedConnection.prototype.isConnectionAllowed = function (a, b) {
    return this.distanceFrom(a) > b
      ? !1
      : Blockly.RenderedConnection.superClass_.isConnectionAllowed.call(
          this,
          a
        );
  };
  ...
  Blockly.Cursor.prototype.onBlocklyAction = function (a) {
    if (
      ...
      this.getCurNode().getLocation().onBlocklyAction(a)
    )
      return !0;
    switch (a.name) {
  ...
  Blockly.BasicCursor.prototype.validNode_ = function (a) {
    ...
    a = a && a.getType();
    if (
      a == Blockly.ASTNode.types.OUTPUT ||
      a == Blockly.ASTNode.types.INPUT ||
      a == Blockly.ASTNode.types.FIELD ||
      a == Blockly.ASTNode.types.NEXT ||
      a == Blockly.ASTNode.types.PREVIOUS ||
      a == Blockly.ASTNode.types.WORKSPACE
    )
      b = !0;
    return b;
  };
  ...
  Blockly.BlockSvg = function (a, b, c) {
    ...
    this.useDragSurface_ =
      Blockly.utils.is3dSupported() && !!a.getBlockDragSurface();
  ...
  Blockly.BlockSvg.prototype.initSvg = function () {
    ...
    this.workspace.options.readOnly ||
      this.eventsInit_ ||
      !a ||
      Blockly.bindEventWithChecks_(a, "mousedown", this, this.onMouseDown_);
    this.eventsInit_ = !0;
      ...
      if (!this.workspace.isClearing && c) {
        ...
        a
          ? (a.getSvgRoot().appendChild(c),
            ...
            this.moveConnections(a.x - d.x, a.y - d.y))
          : b &&
            (this.workspace.getCanvas().appendChild(c),
  ...
  Blockly.BlockSvg.prototype.getRelativeToSurfaceXY = function () {
    ...
    if (d) {
      do {
        ...
        b += e.y;
        this.useDragSurface_ &&
          this.workspace.getBlockDragSurface().getCurrentBlock() == d &&
          ((e = this.workspace.getBlockDragSurface().getSurfaceTranslation()),
          (a += e.x),
          (b += e.y));
        d = d.parentNode;
  ...
  Blockly.BlockSvg.prototype.moveToDragSurface = function () {
    if (this.useDragSurface_) {
      ...
      (a = this.getSvgRoot()) &&
        this.workspace.getBlockDragSurface().setBlocksAndShow(a);
    }
  };
  ...
  Blockly.BlockSvg.prototype.updateCollapsed_ = function () {
    for (
      var a = this.isCollapsed(),
        b = Blockly.Block.COLLAPSED_INPUT_NAME,
        c = Blockly.Block.COLLAPSED_FIELD_NAME,
        d = 0,
        e;
      (e = this.inputList[d]);
      d++
    ...
    if (a) {
      ...
      (e = this.getField(c))
        ? e.setValue(d)
        : ((e = this.getInput(b) || this.appendDummyInput(b)),
  ...
  Blockly.BlockSvg.prototype.tab = function (a, b) {
    ...
    a = c.getCurNode();
    c.onBlocklyAction(
      b ? Blockly.navigation.ACTION_NEXT : Blockly.navigation.ACTION_PREVIOUS
    );
    (b = c.getCurNode()) &&
      b !== a &&
      (b.getLocation().showEditor(),
      this.workspace.keyboardAccessibilityMode &&
        this.workspace.getCursor().setCurNode(b));
  };
  ...
  Blockly.BlockSvg.prototype.setWarningText = function (a, b) {
    ...
    if (this.workspace.isDragging()) {
      ...
      if ("string" == typeof a) {
        ...
        this.warning && !c
          ? (this.warning.dispose(), (b = !0))
          : this.warning &&
            ((b = this.warning.getText()),
    ...
    if (this.workspace && !this.workspace.isDragging()) {
      ...
      if (!a.isInFlyout)
        for (var b = this.getConnections_(!1), c = 0, d; (d = b[c]); c++) {
          ...
          for (
            var e = d.neighbours(Blockly.SNAP_RADIUS), f = 0, g;
            (g = e[f]);
            f++
          )
            (d.isConnected() && g.isConnected()) ||
              (g.getSourceBlock().getRootBlock() != a &&
                (d.isSuperior() ? g.bumpAwayFrom(d) : d.bumpAwayFrom(g)));
        }
    }
  };
  ...
  Blockly.MarkerManager.prototype.registerMarker = function (a, b) {
    ...
    b.setDrawer(
      this.workspace_.getRenderer().makeMarkerDrawer(this.workspace_, b)
    );
  ...
  Blockly.MarkerManager.prototype.setCursorSvg = function (a) {
    a
      ? (this.workspace_.getBlockCanvas().appendChild(a), (this.cursorSvg_ = a))
      : (this.cursorSvg_ = null);
  };
  Blockly.MarkerManager.prototype.setMarkerSvg = function (a) {
    a
      ? this.workspace_.getBlockCanvas() &&
        (this.cursorSvg_
          ? this.workspace_.getBlockCanvas().insertBefore(a, this.cursorSvg_)
          : this.workspace_.getBlockCanvas().appendChild(a))
      : (this.markerSvg_ = null);
  };
  ...
  Blockly.TouchGesture.prototype.handleTouchMove = function (a) {
    ...
    this.cachedPoints_[b] = this.getTouchPoint(a);
    b = Object.keys(this.cachedPoints_);
    this.isPinchZoomEnabled_ && 2 === b.length
      ? this.handlePinch_(a)
      : Blockly.TouchGesture.superClass_.handleMove.call(this, a);
  };
    ...
    c
      ? ((a = new Date()),
        (null != this.lastSound_ &&
          a - this.lastSound_ < Blockly.SOUND_LIMIT) ||
          ((this.lastSound_ = a),
          (c =
      ...
      : this.parentWorkspace_ &&
        this.parentWorkspace_.getAudioManager().play(a, b);
  };
  Blockly.WorkspaceSvg = function (a, b, c) {
    ...
    this.grid_ = this.options.gridPattern
      ? new Blockly.Grid(this.options.gridPattern, a.gridOptions)
      : null;
  ...
  Blockly.WorkspaceSvg.prototype.refreshTheme = function () {
    ...
    this.updateBlockStyles_(
      this.getAllBlocks(!1).filter(function (a) {
  ...
  Blockly.WorkspaceSvg.prototype.createDom = function (a) {
    ...
    if (this.options.hasCategories) {
      ...
      this.toolbox_ = new (Blockly.registry.getClassFromOptions(
    ...
    try {
      ...
      if (!isNaN(e) && !isNaN(f)) {
        ...
        do {
          ...
          if (!a) {
            ...
            for (var m; (m = l[c]); c++)
              if (
                m.closest(
                  Blockly.SNAP_RADIUS,
                  new Blockly.utils.Coordinate(e, f)
                ).connection
              ) {
                a = !0;
                break;
          ...
          a &&
            ((e = this.RTL ? e - Blockly.SNAP_RADIUS : e + Blockly.SNAP_RADIUS),
            (f += 2 * Blockly.SNAP_RADIUS));
        } while (a);
        b.moveBy(e, f);
      }
    } finally {
  ...
  Blockly.WorkspaceSvg.prototype.recordDeleteAreas = function () {
    ...
    this.deleteAreaToolbox_ = this.flyout_
      ...
      : this.toolbox_ && "function" == typeof this.toolbox_.getClientRect
  ...
  Blockly.WorkspaceSvg.prototype.updateToolbox = function (a) {
    Array.isArray(a) || (a = Blockly.Options.parseToolboxTree(a));
    if ((a = Blockly.utils.toolbox.convertToolboxToJSON(a))) {
      ...
      d &&
        (this.flyout_ &&
          (this.horizontalLayout
            ? ((a += this.flyout_.getHeight()),
              (c += this.flyout_.getHeight() / this.scale))
  ...
  Blockly.WorkspaceSvg.prototype.scroll = function (a, b) {
    ...
    this.scrollbar &&
      (this.scrollbar.hScroll.setHandlePosition(
        -(a + c.contentLeft) * this.scrollbar.hScroll.ratio
      ),
      this.scrollbar.vScroll.setHandlePosition(
        -(b + c.contentTop) * this.scrollbar.vScroll.ratio
      ));
    a += c.absoluteLeft;
    b += c.absoluteTop;
    this.translate(a, b);
  ...
  Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    Blockly.utils.dom.addClass(
      e.getInjectionDiv(),
      e.getRenderer().getClassName()
    );
    Blockly.utils.dom.addClass(
      e.getInjectionDiv(),
      e.getTheme().getClassName()
    );
    !b.hasCategories &&
      b.languageTree &&
      ((c = e.addFlyout("svg")), Blockly.utils.dom.insertAfter(c, a));
    b.hasTrashcan && e.addTrashcan();
    b.zoomOptions && b.zoomOptions.controls && e.addZoomControls();
    e.getThemeManager().subscribe(
      a,
      "workspaceBackgroundColour",
      "background-color"
    );
  ...
  Blockly.init_ = function (a) {
    var b = a.options,
      c = a.getParentSvg();
    Blockly.bindEventWithChecks_(c.parentNode, "contextmenu", null, function (
      a
    ) {
    ...
    if (b.languageTree) {
      ...
      c
        ? c.init()
        : d && (d.init(a), d.show(b.languageTree), d.scrollToStart());
    }
  ...
  Blockly.Names.prototype.getName = function (a, b) {
    ...
    c = a.toLowerCase() + "_" + b;
    var d =
      b == Blockly.VARIABLE_CATEGORY_NAME ||
  ...
  Blockly.Procedures.allProcedures = function (a) {
    var b = a.getBlocksByType("procedures_defnoreturn", !1).map(function (a) {
      return a.getProcedureDef();
    });
    a = a.getBlocksByType("procedures_defreturn", !1).map(function (a) {
      return a.getProcedureDef();
    });
  ...
  Blockly.Procedures.updateMutatorFlyout_ = function (a) {
    for (
      var b = [], c = a.getBlocksByType("procedures_mutatorarg", !1), d = 0, e;
      (e = c[d]);
      d++
    )
    ...
    e = Blockly.utils.xml.createElement("field");
    e.setAttribute("name", "NAME");
    b = Blockly.Variables.generateUniqueNameFromOptions(
  ...
  Blockly.Procedures.mutatorChangeListener_ = function (a) {
    if (
      ...
      a.type == Blockly.Events.BLOCK_CHANGE
    )
  ...
  Blockly.Variables.generateUniqueName = function (a) {
    return Blockly.Variables.generateUniqueNameFromOptions(
      ...
      a.getAllVariableNames()
    );
  };
  Blockly.Variables.generateUniqueNameFromOptions = function (a, b) {
    if (!b.length) return a;
    for (
      var c = Blockly.Variables.VAR_LETTER_OPTIONS, d = "", e = c.indexOf(a);
      ;
    ...
    var d = c || "",
      e = function (c) {
        Blockly.Variables.promptName(
          ...
          function (c) {
            if (c) {
              var f = Blockly.Variables.nameUsedWithAnyType(c, a);
              if (f) {
                if (f.type == d)
                  var g = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace(
                    "%1",
                    f.name
                  );
                else
                  (g = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE),
                    (g = g.replace("%1", f.name).replace("%2", f.type));
  ...
  Blockly.Variables.getVariable = function (a, b, c, d) {
    ...
    if (
      b &&
      ((f = a.getVariableById(b)), !f && e && (f = e.getVariableById(b)), f)
    )
      return f;
    if (c) {
      if (void 0 == d)
  ...
  Blockly.WidgetDiv.hide = function () {
    if (Blockly.WidgetDiv.isVisible()) {
      ...
      a.textContent = "";
      Blockly.WidgetDiv.rendererClassName_ &&
        (Blockly.utils.dom.removeClass(a, Blockly.WidgetDiv.rendererClassName_),
        (Blockly.WidgetDiv.rendererClassName_ = ""));
      Blockly.WidgetDiv.themeClassName_ &&
        (Blockly.utils.dom.removeClass(a, Blockly.WidgetDiv.themeClassName_),
        (Blockly.WidgetDiv.themeClassName_ = ""));
      Blockly.getMainWorkspace().markFocused();
    }
  };
  ...
  Blockly.WidgetDiv.calculateX_ = function (a, b, c, d) {
    if (d)
      return (
        (b = Math.max(b.right - c.width, a.left)),
  ...
  Blockly.onKeyDown = function (a) {
    ...
    if (
      b &&
      !(Blockly.utils.isTargetInput(a) || (b.rendered && !b.isVisible()))
    )
      if (b.options.readOnly) Blockly.navigation.onKeyPress(a);
        ...
        if (a.keyCode == Blockly.utils.KeyCodes.ESC)
          ...
          if (!Blockly.Gesture.inProgress() && Blockly.navigation.onKeyPress(a))
            return;
          if (
            ...
            a.keyCode == Blockly.utils.KeyCodes.V
              ...
              : a.ctrlKey &&
                a.keyCode == Blockly.utils.KeyCodes.Y &&
                (Blockly.hideChaff(), b.undo(!0));
          }
        }
        c &&
          !Blockly.selected.workspace.isFlyout &&
  ...
  Blockly.hideChaff = function (a) {
    ...
    a ||
      ...
      a.trashcan && a.trashcan.flyout && a.trashcan.flyout.hide(),
      (a = a.getToolbox()) &&
        a.getFlyout() &&
        a.getFlyout().autoClose &&
        a.clearSelection());
  };
  ...
  Blockly.Css.register(
    ".blocklyCommentTextarea {,background-color: #fef49c;,border: 0;,outline: 0;,margin: 0;,padding: 3px;,resize: none;,display: block;,overflow: hidden;,}".split(
      ","
    )
  );
  ...
  Blockly.Flyout.prototype.show = function (a) {
    ...
    this.listeners_.push(
      Blockly.bindEventWithChecks_(
        ...
        function () {
          for (
            var a = this.workspace_.getTopBlocks(!1), c = 0, d;
            (d = a[c]);
            c++
          )
            d.removeSelect();
  ...
  Blockly.Flyout.prototype.createFlyoutInfo_ = function (a) {
    ...
    for (
      var d = this.horizontalLayout ? this.GAP_X : this.GAP_Y, e = 0, f;
      (f = a[e]);
      e++
    )
  ...
  Blockly.Flyout.prototype.createButton_ = function (a, b) {
    ...
    return new Blockly.FlyoutButton(
      this.workspace_,
      this.targetWorkspace,
      a,
      b
  ...
  Blockly.Flyout.prototype.clearOldBlocks_ = function () {
    ...
    for (b = 0; b < this.mats_.length; b++)
      if ((a = this.mats_[b]))
        Blockly.Tooltip.unbindMouseEvents(a), Blockly.utils.dom.removeNode(a);
  ...
  Blockly.Flyout.prototype.addBlockListeners_ = function (a, b, c) {
    ...
    this.listeners_.push(
      Blockly.bindEvent_(a, "mouseleave", b, b.removeSelect)
    );
    this.listeners_.push(Blockly.bindEvent_(c, "mouseenter", b, b.addSelect));
    this.listeners_.push(
      Blockly.bindEvent_(c, "mouseleave", b, b.removeSelect)
    );
  };
  ...
  Blockly.Flyout.prototype.filterForCapacity_ = function () {
    for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; (c = a[b]); b++)
      if (-1 == this.permanentlyDisabled_.indexOf(c))
        for (
          var d = this.targetWorkspace.isCapacityAvailable(
  ...
  Blockly.HorizontalFlyout.prototype.layout_ = function (a, b) {
    ...
    for (var e = 0, f; (f = a[e]); e++)
      if ("block" == f.type) {
        ...
        "button" == f.type &&
          (this.initFlyoutButton_(f.button, d, c),
  ...
  Blockly.VerticalFlyout.prototype.getClientRect = function () {
    ...
    return this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
      ? new Blockly.utils.Rect(-1e9, 1e9, -1e9, b + a.width)
      : new Blockly.utils.Rect(-1e9, 1e9, b, 1e9);
  };
  ...
  Blockly.Generator.prototype.provideFunction_ = function (a, b) {
    if (!this.definitions_[a]) {
      var c = this.variableDB_.getDistinctName(
        a,
        Blockly.PROCEDURE_CATEGORY_NAME
      );
    ...
    if ((b = this.getElement()))
      if (
        ...
        d ||
          (c
            ? c.updateExpandIcon()
            : (Blockly.utils.style.setElementShown(b, !0),
  ...
  Blockly.tree.BaseNode.prototype.getDepth = function () {
    var a = this.depth_;
    0 > a &&
      ((a = (a = this.getParent()) ? a.getDepth() + 1 : 0), this.setDepth_(a));
    return a;
  };
  ...
  Blockly.tree.BaseNode.prototype.getParent = function () {
    return Blockly.tree.BaseNode.superClass_.getParent.call(this);
  };
  ...
  Blockly.tree.BaseNode.prototype.getRowDom = function () {
    ...
    a.style["padding-" + (this.rightToLeft_ ? "right" : "left")] =
  ...
  Blockly.tree.BaseNode.prototype.selectParent = function () {
    if (this.hasChildren() && this.expanded_) this.setExpanded(!1);
    else {
      var a = this.getParent(),
        b = this.getTree();
      a && a != b && a.select();
  ...
  Blockly.tree.BaseNode.prototype.selectChild = function () {
    return this.hasChildren()
      ? (this.expanded_ ? this.getChildAt(0).select() : this.setExpanded(!0),
        !0)
      : !1;
  };
  Blockly.tree.BaseNode.prototype.getLastShownDescendant = function () {
    return this.expanded_ && this.hasChildren()
  ...
  Blockly.tree.TreeControl = function (a, b) {
    this.toolbox_ = a;
    this.onKeydownWrapper_ = this.onClickWrapper_ = null;
    Blockly.tree.BaseNode.call(this, "", b);
    this.selected_ = this.expanded_ = !0;
    this.selectedItem_ = this;
    this.onAfterSelected_ = this.onBeforeSelected_ = null;
  };
  Blockly.utils.object.inherits(
  ...
  Blockly.tree.TreeControl.prototype.handleMouseEvent_ = function (a) {
    ...
    if (b && "click" == a.type) b.onClick_(a);
  };
  Blockly.tree.TreeControl.prototype.handleKeyEvent_ = function (a) {
    var b = !(!this.selectedItem_ || !this.selectedItem_.onKeyDown(a));
    b &&
  ...
  Blockly.tree.TreeControl.prototype.createNode = function (a) {
    return new Blockly.tree.TreeNode(this.toolbox_, a || "", this.config_);
  };
  ...
  Blockly.Toolbox.prototype.init = function () {
    ...
    this.render(a.options.languageTree);
  };
  Blockly.Toolbox.prototype.render = function (a) {
    ...
    if (a) {
      this.tree_.contents = [];
      this.hasColours_ = !1;
      c = this.createTree_(a, this.tree_);
  ...
  Blockly.Toolbox.prototype.createTree_ = function (a, b) {
    var c = null,
      d = null;
    if (!a) return null;
    for (var e = 0, f; (f = a[e]); e++)
      switch (f.kind.toUpperCase()) {
        case "CATEGORY":
          c = this.addCategory_(f, b) || c;
          d = f;
          break;
        case "SEP":
          d = this.addSeparator_(f, b, d) || d;
          break;
        case "BLOCK":
        case "SHADOW":
        case "LABEL":
        case "BUTTON":
          b.contents.push(f), (d = f);
      }
    return c;
  };
  Blockly.Toolbox.prototype.addCategory_ = function (a, b) {
    var c = null,
      d = Blockly.utils.replaceMessageReferences(a.name),
      e = this.tree_.createNode(d);
    e.onSizeChanged(this.handleNodeSizeChanged_);
    e.contents = [];
    b.add(e);
    (b = a.custom)
      ? (e.contents = b)
      : (c = this.createTree_(a.contents, e) || c);
    this.setColourOrStyle_(a, e, d);
    return (c = this.setExpanded_(a, e) || c);
  };
  Blockly.Toolbox.prototype.setColourOrStyle_ = function (a, b, c) {
    var d = a.categorystyle;
    (a = a.colour) && d
      ? ((b.hexColour = ""),
        console.warn(
          'Toolbox category "' + c + '" must not have both a style and a colour'
        ))
      : d
      ? this.setColourFromStyle_(d, b, c)
      : this.setColour_(a, b, c);
  };
  Blockly.Toolbox.prototype.addSeparator_ = function (a, b, c) {
    if (c && "CATEGORY" == c.kind.toUpperCase())
      b.add(new Blockly.Toolbox.TreeSeparator(this.treeSeparatorConfig_));
    else return b.contents.push(a), a;
    return null;
  };
  Blockly.Toolbox.prototype.setExpanded_ = function (a, b) {
    var c = null;
    "true" == a.expanded
      ? (b.contents.length && (c = b), b.setExpanded(!0))
      : b.setExpanded(!1);
    return c;
  };
  ...
  Blockly.Toolbox.prototype.handleAfterTreeSelected_ = function (a, b) {
    b && b.contents && b.contents.length
      ? (this.flyout_.show(b.contents),
  ...
  Blockly.Toolbox.prototype.refreshSelection = function () {
    ...
    a && a.contents && this.flyout_.show(a.contents);
  };
  Blockly.Toolbox.prototype.selectFirstCategory = function () {
    this.tree_.getSelectedItem() || this.tree_.selectChild();
  };
  ...
  Blockly.Trashcan.prototype.animateLid_ = function () {
    ...
    this.svgGroup_.style.opacity =
      b + this.lidOpen_ * (Blockly.Trashcan.OPACITY_MAX_ - b);
    this.lidOpen_ > this.minOpenness_ &&
      1 > this.lidOpen_ &&
      (this.lidTask_ = setTimeout(
        this.animateLid_.bind(this),
        Blockly.Trashcan.ANIMATION_LENGTH_ / a
      ));
  };
  ...
  Blockly.Mutator.prototype.createEditor_ = function () {
    ...
    b.toolboxPosition = this.block_.RTL
      ? Blockly.TOOLBOX_AT_RIGHT
      : Blockly.TOOLBOX_AT_LEFT;
    if ((c = !!a))
      (b.languageTree = Blockly.utils.toolbox.convertToolboxToJSON(a)),
    ...
    a = c ? this.workspace_.addFlyout("g") : null;
    ...
    if (
      ...
      this.rootBlock_.workspace == this.workspace_ &&
        ...
        Blockly.getMainWorkspace().keyboardAccessibilityMode &&
          Blockly.navigation.moveCursorOnBlockMutation(a),
        (c = (c = a.mutationToDom()) && Blockly.Xml.domToText(c)),
        b != c &&
          Blockly.Events.fire(
            new Blockly.Events.BlockChange(a, "mutation", null, b, c)
          ),
  ...
  Blockly.FieldTextInput.prototype.initView = function () {
    if (this.getConstants().FULL_BLOCK_FIELDS) {
      for (
        var a = 0, b = 0, c = 0, d;
        (d = this.sourceBlock_.inputList[c]);
        c++
      ) {
      ...
      this.fullBlockClickTarget_ =
        1 >= a && this.sourceBlock_.outputConnection && !b;
  ...
  Blockly.FieldTextInput.prototype.render_ = function () {
    ...
    if (this.isBeingEdited_) {
      ...
      this.isTextValid_
        ? (Blockly.utils.dom.removeClass(a, "blocklyInvalidInput"),
          Blockly.utils.aria.setState(a, Blockly.utils.aria.State.INVALID, !1))
        : (Blockly.utils.dom.addClass(a, "blocklyInvalidInput"),
  ...
  Blockly.FieldTextInput.prototype.showPromptEditor_ = function () {
    var a = this;
    Blockly.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.getText(), function (
      b
    ) {
      a.setValue(b);
    });
  ...
  Blockly.FieldColour.prototype.initView = function () {
    ...
    this.getConstants().FIELD_COLOUR_FULL_BLOCK
      ? (this.clickTarget_ = this.sourceBlock_.getSvgRoot())
      : (this.createBorderRect_(), (this.borderRect_.style.fillOpacity = "1"));
  };
  ...
  Blockly.FieldColour.prototype.doValueUpdate_ = function (a) {
    ...
    this.borderRect_
      ...
      : this.sourceBlock_ &&
        this.sourceBlock_.rendered &&
        (this.sourceBlock_.pathObject.svgPath.setAttribute("fill", a),
        this.sourceBlock_.pathObject.svgPath.setAttribute("stroke", "#fff"));
  };
  ...
  Blockly.FieldColour.prototype.moveHighlightBy_ = function (a, b) {
    ...
    this.setHighlightedCell_(
      this.picker_.childNodes[f].childNodes[e],
      f * d + e
    );
  };
  ...
  Blockly.FieldDropdown.prototype.showEditor_ = function (a) {
    ...
    this.menu_.openingCoords =
      a && "number" === typeof a.clientX
        ? new Blockly.utils.Coordinate(a.clientX, a.clientY)
        : null;
  ...
  Blockly.FieldDropdown.prototype.renderSelectedImage_ = function (a) {
    ...
    var c = !!this.borderRect_,
      d = Math.max(
        c ? this.getConstants().FIELD_DROPDOWN_BORDER_RECT_HEIGHT : 0,
        b + Blockly.FieldDropdown.IMAGE_Y_PADDING
      );
    c = c ? this.getConstants().FIELD_BORDER_RECT_X_PADDING : 0;
    var e = this.svgArrow_
      ? this.positionSVGArrow_(
          a + c,
          d / 2 - this.getConstants().FIELD_DROPDOWN_SVG_ARROW_SIZE / 2
        )
    ...
    var f = 0;
    this.sourceBlock_.RTL
      ? this.imageElement_.setAttribute("x", c + e)
      : ((f = a + e),
  ...
  Blockly.FieldDropdown.prototype.renderSelectedText_ = function () {
    ...
    var a = !!this.borderRect_,
      ...
      c = Blockly.utils.dom.getFastTextWidth(
        this.textElement_,
        this.getConstants().FIELD_TEXT_FONTSIZE,
        this.getConstants().FIELD_TEXT_FONTWEIGHT,
        this.getConstants().FIELD_TEXT_FONTFAMILY
    ...
    var d = 0;
    this.svgArrow_ &&
      (d = this.positionSVGArrow_(
        c + a,
        b / 2 - this.getConstants().FIELD_DROPDOWN_SVG_ARROW_SIZE / 2
      ));
  ...
  Blockly.FieldDropdown.prototype.positionSVGArrow_ = function (a, b) {
    ...
    this.svgArrow_.setAttribute(
      "transform",
      "translate(" + (this.sourceBlock_.RTL ? c : a + d) + "," + b + ")"
    );
    return e + d;
  };
  ...
  Blockly.FieldMultilineInput.prototype.render_ = function () {
    ...
    for (var b = 0, c = 0; c < a.length; c++) {
      ...
      Blockly.utils.dom
        ...
        .appendChild(document.createTextNode(a[c]));
      b += d;
    }
    this.updateSize_();
    this.isBeingEdited_ &&
  ...
  Blockly.FieldMultilineInput.prototype.updateSize_ = function () {
    for (
      ...
      c +=
        this.getConstants().FIELD_TEXT_HEIGHT +
        (0 < d ? this.getConstants().FIELD_BORDER_RECT_Y_PADDING : 0);
    }
    this.borderRect_ &&
      ((c += 2 * this.getConstants().FIELD_BORDER_RECT_Y_PADDING),
  ...
  Blockly.FieldVariable.prototype.fromXml = function (a) {
    var b = a.getAttribute("id"),
      c = a.textContent,
      d =
        a.getAttribute("variabletype") || a.getAttribute("variableType") || "";
  ...
  Blockly.blockRendering.ConstantProvider.prototype.setDynamicProperties_ = function (
    a
  ) {
    this.setFontConstants_(a);
    this.setComponentConstants_(a);
    this.ADD_START_HATS =
      null != a.startHats ? a.startHats : this.ADD_START_HATS;
  };
  Blockly.blockRendering.ConstantProvider.prototype.setFontConstants_ = function (
    a
  ) {
    this.FIELD_TEXT_FONTFAMILY =
      a.fontStyle && void 0 != a.fontStyle.family
        ? a.fontStyle.family
        : this.FIELD_TEXT_FONTFAMILY;
    this.FIELD_TEXT_FONTWEIGHT =
      a.fontStyle && void 0 != a.fontStyle.weight
        ? a.fontStyle.weight
        : this.FIELD_TEXT_FONTWEIGHT;
  ...
  Blockly.blockRendering.ConstantProvider.prototype.setComponentConstants_ = function (
    a
  ) {
    this.CURSOR_COLOUR =
      a.getComponentStyle("cursorColour") || this.CURSOR_COLOUR;
    this.MARKER_COLOUR =
      a.getComponentStyle("markerColour") || this.MARKER_COLOUR;
    this.INSERTION_MARKER_COLOUR =
      a.getComponentStyle("insertionMarkerColour") ||
      this.INSERTION_MARKER_COLOUR;
    this.INSERTION_MARKER_OPACITY =
      Number(a.getComponentStyle("insertionMarkerOpacity")) ||
      this.INSERTION_MARKER_OPACITY;
  };
  Blockly.blockRendering.ConstantProvider.prototype.getBlockStyleForColour = function (
    a
  ) {
    var b = "auto_" + a;
  ...
  Blockly.blockRendering.ConstantProvider.prototype.getBlockStyle = function (
    ...
    return (
      this.blockStyles[a || ""] ||
      (a && 0 == a.indexOf("auto_")
        ? this.getBlockStyleForColour(a.substring(5)).style
  ...
  Blockly.blockRendering.ConstantProvider.prototype.validatedBlockStyle_ = function (
    a
  ) {
    var b = {};
    ...
    b.colourSecondary = b.colourSecondary
      ? Blockly.utils.parseBlockColour(b.colourSecondary).hex
      : this.generateSecondaryColour_(b.colourPrimary);
    b.colourTertiary = b.colourTertiary
      ? Blockly.utils.parseBlockColour(b.colourTertiary).hex
      : this.generateTertiaryColour_(b.colourPrimary);
    b.hat = b.hat || "";
    return b;
  };
  Blockly.blockRendering.ConstantProvider.prototype.generateSecondaryColour_ = function (
    a
  ) {
    return Blockly.utils.colour.blend("#fff", a, 0.6) || a;
  };
  Blockly.blockRendering.ConstantProvider.prototype.generateTertiaryColour_ = function (
    a
  ) {
    return Blockly.utils.colour.blend("#fff", a, 0.3) || a;
  };
  ...
  Blockly.blockRendering.ConstantProvider.prototype.makeJaggedTeeth = function () {
    var a = this.JAGGED_TEETH_HEIGHT,
      ...
      c = Blockly.utils.svgPaths.line([
        ...
        Blockly.utils.svgPaths.point(2 * -b, a / 2),
        Blockly.utils.svgPaths.point(b, a / 4),
      ]);
  ...
  Blockly.blockRendering.ConstantProvider.prototype.createDom = function (
    ...
    c = Blockly.utils.dom.createSvgElement(
      "feSpecularLighting",
      {
        in: "blur",
        surfaceScale: 1,
  ...
  Blockly.blockRendering.ConstantProvider.prototype.injectCSS_ = function (
    ...
    var c = b.join("\n");
    this.cssNode_
      ? (this.cssNode_.firstChild.textContent = c)
  ...
  Blockly.blockRendering.MarkerSvg.prototype.showAtLocation_ = function (a) {
    var b = a.getLocation();
    a.getType() == Blockly.ASTNode.types.BLOCK
      ? this.showWithBlock_(a)
      : a.getType() == Blockly.ASTNode.types.OUTPUT
      ? this.showWithOutput_(a)
      : b.type == Blockly.INPUT_VALUE
      ? this.showWithInput_(a)
      : b.type == Blockly.NEXT_STATEMENT
      ? this.showWithNext_(a)
      : a.getType() == Blockly.ASTNode.types.PREVIOUS
      ? this.showWithPrevious_(a)
  ...
  Blockly.blockRendering.MarkerSvg.prototype.showWithBlockPrevOutput_ = function (
    ...
    if (a.previousConnection) {
      ...
      a.outputConnection
        ? ((f = this.constants_.shapeFor(a.outputConnection)),
          this.positionOutput_(b, c, f))
  ...
  Blockly.blockRendering.MarkerSvg.prototype.positionBlock_ = function (
    ...
    a =
      Blockly.utils.svgPaths.moveBy(-b, c) +
  ...
  Blockly.blockRendering.MarkerSvg.prototype.positionInput_ = function (a) {
    ...
    a =
      ...
      this.constants_.shapeFor(a).pathDown;
  ...
  Blockly.blockRendering.MarkerSvg.prototype.positionOutput_ = function (
    ...
    a =
      Blockly.utils.svgPaths.moveBy(a, 0) +
      Blockly.utils.svgPaths.lineOnAxis("h", -(a - c.width)) +
  ...
  Blockly.blockRendering.MarkerSvg.prototype.fireMarkerEvent_ = function (
    ...
    b.getType() == Blockly.ASTNode.types.WORKSPACE &&
      (a.workspaceId = b.getLocation().id);
    Blockly.Events.fire(a);
  };
  ...
  Blockly.blockRendering.MarkerSvg.prototype.applyColour_ = function (a) {
    ...
    this.isCursor() &&
      ((a = this.colour_ + ";transparent;transparent;"),
  ...
  Blockly.blockRendering.InputConnection = function (a, b) {
    ...
    (this.connectedBlock =
      b.connection && b.connection.targetBlock()
        ...
        : null)
      ? ((a = this.connectedBlock.getHeightWidth()),
        (this.connectedBlockWidth = a.width),
        (this.connectedBlockHeight = a.height))
  ...
  Blockly.blockRendering.TopRow.prototype.hasLeftSquareCorner = function (a) {
    var b =
        (a.hat ? "cap" === a.hat : this.constants_.ADD_START_HATS) &&
        !a.outputConnection &&
        !a.previousConnection,
  ...
  Blockly.blockRendering.SpacerRow = function (a, b, c) {
    ...
    this.elements = [
      new Blockly.blockRendering.InRowSpacer(this.constants_, c),
    ];
  };
  Blockly.utils.object.inherits(
  ...
  Blockly.blockRendering.RenderInfo.prototype.alignRowElements_ = function () {
    for (var a = 0, b; (b = this.rows[a]); a++)
      if (b.hasStatement) this.alignStatementRow_(b);
        ...
        Blockly.blockRendering.Types.isTopOrBottomRow(b) &&
  ...
  Blockly.blockRendering.RenderInfo.prototype.addAlignmentPadding_ = function (
    ...
    a.align == Blockly.ALIGN_LEFT
      ? (d.width += b)
      : a.align == Blockly.ALIGN_CENTRE
      ? ((c.width += b / 2), (d.width += b / 2))
      : a.align == Blockly.ALIGN_RIGHT
      ? (c.width += b)
      : (d.width += b);
    a.width += b;
  };
  ...
  Blockly.blockRendering.RenderInfo.prototype.getElemCenterline_ = function (
    ...
    return Blockly.blockRendering.Types.isSpacer(b)
      ? a.yPos + b.height / 2
      : Blockly.blockRendering.Types.isBottomRow(a)
  ...
  Blockly.blockRendering.Drawer.prototype.drawTop_ = function () {
    ...
    for (var c = 0, d; (d = b[c]); c++)
      Blockly.blockRendering.Types.isLeftRoundedCorner(d)
        ...
        : Blockly.blockRendering.Types.isRightRoundedCorner(d)
  ...
  Blockly.blockRendering.Drawer.prototype.drawBottom_ = function () {
    ...
    for (var c = 0, d = "", e = b.length - 1, f; (f = b[e]); e--)
      Blockly.blockRendering.Types.isNextConnection(f)
        ? (d += f.shape.pathRight)
        : Blockly.blockRendering.Types.isLeftSquareCorner(f)
        ? (d += Blockly.utils.svgPaths.lineOnAxis("H", a.xPos))
        : Blockly.blockRendering.Types.isLeftRoundedCorner(f)
        ? (d += this.constants_.OUTSIDE_CORNERS.bottomLeft)
        : Blockly.blockRendering.Types.isRightRoundedCorner(f)
        ? ((d += this.constants_.OUTSIDE_CORNERS.bottomRight),
          (c = this.constants_.OUTSIDE_CORNERS.rightHeight))
        : Blockly.blockRendering.Types.isSpacer(f) &&
          (d += Blockly.utils.svgPaths.lineOnAxis("h", -1 * f.width));
  ...
  Blockly.blockRendering.Drawer.prototype.layoutField_ = function (a) {
    ...
    this.info_.RTL &&
      ((d = -(d + a.width)),
      a.flipRtl && ((d += a.width), (e = "scale(-1 1)")));
  ...
  Blockly.blockRendering.PathObject.prototype.setCursorSvg = function (a) {
    a
      ? (this.svgRoot.appendChild(a), (this.cursorSvg = a))
      : (this.cursorSvg = null);
  };
  Blockly.blockRendering.PathObject.prototype.setMarkerSvg = function (a) {
    a
      ? (this.cursorSvg
          ? this.svgRoot.insertBefore(a, this.cursorSvg)
          : this.svgRoot.appendChild(a),
        (this.markerSvg = a))
      : (this.markerSvg = null);
  };
  ...
  Blockly.blockRendering.PathObject.prototype.setClass_ = function (a, b) {
    b
      ? Blockly.utils.dom.addClass(this.svgRoot, a)
      : Blockly.utils.dom.removeClass(this.svgRoot, a);
  };
  ...
  Blockly.blockRendering.PathObject.prototype.updateShapeForInputHighlight = function (
    a,
    b
  ) {};
  ...
  Blockly.blockRendering.Renderer.prototype.orphanCanConnectAtEnd = function (
    ...
    c == Blockly.OUTPUT_VALUE
      ? ((c = b.outputConnection),
        (a = Blockly.Connection.lastConnectionInRow(a, b)))
      : ((c = b.previousConnection), (a = a.lastConnectionInStack()));
  ...
  Blockly.blockRendering.Renderer.prototype.getConnectionPreviewMethod = function (
    ...
    return b.type == Blockly.OUTPUT_VALUE ||
      ...
      ? !a.isConnected() ||
        this.orphanCanConnectAtEnd(c, a.targetBlock(), b.type)
  ...
  Blockly.geras.ConstantProvider.prototype.getCSS_ = function (a) {
    return Blockly.geras.ConstantProvider.superClass_.getCSS_
      .call(this, a)
      .concat([
    ...
    for (b = 0; (c = this.rows[b]); b++) {
      ...
      c.startsWithElemSpacer() &&
        c.elements.push(
          new Blockly.blockRendering.InRowSpacer(
            this.constants_,
            this.getInRowSpacing_(null, d[0])
          )
        );
      if (d.length) {
        for (var e = 0; e < d.length - 1; e++) {
          ...
          c.elements.push(
            new Blockly.blockRendering.InRowSpacer(this.constants_, f)
          );
        }
        c.elements.push(d[d.length - 1]);
        c.endsWithElemSpacer() &&
          ((f = this.getInRowSpacing_(d[d.length - 1], null)),
  ...
  Blockly.geras.RenderInfo.prototype.getInRowSpacing_ = function (a, b) {
    ...
    if (Blockly.blockRendering.Types.isLeftSquareCorner(a) && b) {
      ...
      if (Blockly.blockRendering.Types.isNextConnection(b))
        return (
          (a = ((this.RTL ? 1 : -1) * this.constants_.DARK_PATH_OFFSET) / 2),
          b.notchOffset + a
        );
    }
  ...
  Blockly.geras.RenderInfo.prototype.getSpacerRowHeight_ = function (a, b) {
    return Blockly.blockRendering.Types.isTopRow(a) &&
      ...
      : (a.hasStatement && b.hasStatement) ||
        (!a.hasStatement && b.hasDummyInput) ||
        a.hasDummyInput
      ? this.constants_.LARGE_PADDING
      : this.constants_.MEDIUM_PADDING;
  };
  ...
  Blockly.geras.RenderInfo.prototype.alignRowElements_ = function () {
    if (this.isInline) {
      for (
        var a = 0, b = null, c = this.rows.length - 1, d;
        (d = this.rows[c]);
        c--
      )
        (d.nextRightEdge = a),
          Blockly.blockRendering.Types.isInputRow(d) &&
            (d.hasStatement && this.alignStatementRow_(d),
            b && b.hasStatement && d.width < b.width
              ? (d.nextRightEdge = b.width)
              : (a = d.width),
            (b = d));
      for (c = a = 0; (d = this.rows[c]); c++)
        d.hasStatement
          ? (a = this.getDesiredRowWidth_(d))
          : Blockly.blockRendering.Types.isSpacer(d)
          ? (d.width = Math.max(a, d.nextRightEdge))
          : ((a = Math.max(a, d.nextRightEdge) - d.width),
  ...
  Blockly.geras.RenderInfo.prototype.getDesiredRowWidth_ = function (a) {
    return this.isInline && a.hasStatement
  ...
  Blockly.geras.Drawer.prototype.drawRightSideRow_ = function (a) {
    ...
    this.outlinePath_ +=
      Blockly.utils.svgPaths.lineOnAxis("H", a.xPos + a.width) +
      Blockly.utils.svgPaths.lineOnAxis("V", a.yPos + a.height);
  };
  ...
  Blockly.geras.Drawer.prototype.positionStatementInputConnection_ = function (
    ...
    if (b.connectionModel) {
      ...
      b.connectionModel.setOffsetInBlock(
        c,
        a.yPos + this.constants_.DARK_PATH_OFFSET
      );
    }
  };
  ...
  Blockly.geras.Drawer.prototype.positionNextConnection_ = function () {
    ...
    if (a.connection) {
      var b = a.connection,
        c = b.xPos;
      b.connectionModel.setOffsetInBlock(
        (this.info_.RTL ? -c : c) + this.constants_.DARK_PATH_OFFSET / 2,
        a.baseline + this.constants_.DARK_PATH_OFFSET
      );
    }
  };
  ...
  Blockly.thrasos.RenderInfo.prototype.getInRowSpacing_ = function (a, b) {
    ...
    return Blockly.blockRendering.Types.isLeftRoundedCorner(a) && b
      ? b.notchOffset - this.constants_.CORNER_RADIUS
      : (Blockly.blockRendering.Types.isField(a) &&
          b &&
          Blockly.blockRendering.Types.isField(b) &&
          a.isEditable == b.isEditable) ||
        (b && Blockly.blockRendering.Types.isJaggedEdge(b))
  ...
  Blockly.thrasos.RenderInfo.prototype.getSpacerRowHeight_ = function (a, b) {
    return Blockly.blockRendering.Types.isTopRow(a) &&
      ...
      : !a.hasStatement && b.hasStatement
      ? this.constants_.BETWEEN_STATEMENT_PADDING_Y
      : (a.hasStatement && b.hasStatement) || a.hasDummyInput || b.hasDummyInput
      ? this.constants_.LARGE_PADDING
      : this.constants_.MEDIUM_PADDING;
  };
  Blockly.thrasos.RenderInfo.prototype.getElemCenterline_ = function (a, b) {
    ...
    var c = a.yPos;
    return (c =
      Blockly.blockRendering.Types.isField(b) && a.hasStatement
  ...
  Blockly.zelos.ConstantProvider.prototype.setFontConstants_ = function (a) {
    ...
    this.FIELD_DROPDOWN_BORDER_RECT_HEIGHT = this.FIELD_BORDER_RECT_HEIGHT =
      this.FIELD_TEXT_HEIGHT + 2 * this.FIELD_BORDER_RECT_Y_PADDING;
  };
  ...
  Blockly.zelos.ConstantProvider.prototype.setDynamicProperties_ = function (
    ...
    Blockly.zelos.ConstantProvider.superClass_.setDynamicProperties_.call(
      this,
      a
    );
    this.SELECTED_GLOW_COLOUR =
      a.getComponentStyle("selectedGlowColour") || this.SELECTED_GLOW_COLOUR;
    ...
    this.REPLACEMENT_GLOW_COLOUR =
      a.getComponentStyle("replacementGlowColour") ||
      this.REPLACEMENT_GLOW_COLOUR;
    this.REPLACEMENT_GLOW_SIZE =
      (a = Number(a.getComponentStyle("replacementGlowSize"))) && !isNaN(a)
        ? a
        : this.REPLACEMENT_GLOW_SIZE;
  };
  ...
  Blockly.zelos.ConstantProvider.prototype.makeStartHat = function () {
    var a = this.START_HAT_HEIGHT,
      b = this.START_HAT_WIDTH,
      c = Blockly.utils.svgPaths.curve("c", [
        Blockly.utils.svgPaths.point(25, -a),
        Blockly.utils.svgPaths.point(71, -a),
        Blockly.utils.svgPaths.point(b, 0),
      ]);
    return { height: a, width: b, path: c };
  };
  Blockly.zelos.ConstantProvider.prototype.makeHexagonal = function () {
    function a(a, d, e) {
      ...
      a = ((d ? -1 : 1) * a) / 2;
      return (
        Blockly.utils.svgPaths.lineTo(-e * c, a) +
        Blockly.utils.svgPaths.lineTo(e * c, a)
      );
    }
    ...
    function a(a, b, f) {
      ...
      return (
        Blockly.utils.svgPaths.arc(
          ...
          "0 0,1",
          a,
          Blockly.utils.svgPaths.point((b ? -1 : 1) * a, (b ? -1 : 1) * a)
        ) +
        Blockly.utils.svgPaths.lineOnAxis("v", (f ? 1 : -1) * d) +
        Blockly.utils.svgPaths.arc(
          "a",
          "0 0,1",
          a,
    ...
    function a(a, d, e) {
      ...
      return (
        Blockly.utils.svgPaths.arc(
          ...
          "0 0,1",
          b,
          Blockly.utils.svgPaths.point((d ? -1 : 1) * b, (d ? -1 : 1) * b)
        ) +
        Blockly.utils.svgPaths.lineOnAxis("v", (e ? 1 : -1) * a) +
        Blockly.utils.svgPaths.arc(
          "a",
          "0 0,1",
          b,
  ...
  Blockly.zelos.ConstantProvider.prototype.makeNotch = function () {
    function a(a) {
      return (
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((a * e) / 2, 0),
          Blockly.utils.svgPaths.point((a * e * 3) / 4, g / 2),
          Blockly.utils.svgPaths.point(a * e, g),
        ]) +
        Blockly.utils.svgPaths.line([Blockly.utils.svgPaths.point(a * e, f)]) +
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((a * e) / 4, g / 2),
          Blockly.utils.svgPaths.point((a * e) / 2, g),
          Blockly.utils.svgPaths.point(a * e, g),
        ]) +
        Blockly.utils.svgPaths.lineOnAxis("h", a * d) +
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((a * e) / 2, 0),
          Blockly.utils.svgPaths.point((a * e * 3) / 4, -(g / 2)),
          Blockly.utils.svgPaths.point(a * e, -g),
  ...
  Blockly.zelos.ConstantProvider.prototype.generateSecondaryColour_ = function (
    ...
    return Blockly.utils.colour.blend("#000", a, 0.15) || a;
  };
  Blockly.zelos.ConstantProvider.prototype.generateTertiaryColour_ = function (
    a
  ) {
    return Blockly.utils.colour.blend("#000", a, 0.25) || a;
  };
  ...
  Blockly.zelos.ConstantProvider.prototype.getCSS_ = function (a) {
    return [
      ...
      a + " .blocklyEditableText>rect:not(.blocklyDropdownRect) {",
      "fill: " + this.FIELD_BORDER_RECT_COLOUR + ";",
      "}",
      a + " .blocklyNonEditableText>text,",
      a + " .blocklyEditableText>text,",
      a + " .blocklyNonEditableText>g>text,",
      a + " .blocklyEditableText>g>text {",
      "fill: #575E75;",
      "}",
      a + " .blocklyFlyoutLabelText {",
      "fill: #575E75;",
      ...
      "font-family: " + this.FIELD_TEXT_FONTFAMILY + ";",
      "}",
      a + ".blocklyDropDownDiv .goog-menuitem-content {",
      "color: #fff;",
      "}",
      a + " .blocklyHighlightedConnectionPath {",
      "stroke: " + this.SELECTED_GLOW_COLOUR + ";",
      "}",
      a + " .blocklyDisabled > .blocklyOutlinePath {",
  ...
  Blockly.zelos.RenderInfo.prototype.getDesiredRowWidth_ = function (a) {
    return a.hasStatement
      ...
      : Blockly.zelos.RenderInfo.superClass_.getDesiredRowWidth_.call(this, a);
  };
  Blockly.zelos.RenderInfo.prototype.getInRowSpacing_ = function (a, b) {
    return (a && b) ||
      ...
      this.bottomRow.hasNextConnection
      ? !a && b && Blockly.blockRendering.Types.isStatementInput(b)
        ? this.constants_.STATEMENT_INPUT_PADDING_LEFT
        : a &&
          Blockly.blockRendering.Types.isLeftRoundedCorner(a) &&
          b &&
  ...
  Blockly.zelos.RenderInfo.prototype.getSpacerRowHeight_ = function (a, b) {
    ...
    return d || c
      ...
      ? a.hasPreviousConnection ||
        ...
        ? this.constants_.NO_PADDING
        : Math.abs(this.constants_.NOTCH_HEIGHT - this.constants_.CORNER_RADIUS)
      : Blockly.blockRendering.Types.isBottomRow(b)
      ? this.outputConnection
  ...
  Blockly.zelos.RenderInfo.prototype.getSpacerRowWidth_ = function (a, b) {
    ...
    return (Blockly.blockRendering.Types.isInputRow(a) && a.hasStatement) ||
      (Blockly.blockRendering.Types.isInputRow(b) && b.hasStatement)
  ...
  Blockly.zelos.RenderInfo.prototype.getElemCenterline_ = function (a, b) {
    if (
      a.hasStatement &&
      !Blockly.blockRendering.Types.isSpacer(b) &&
      !Blockly.blockRendering.Types.isStatementInput(b)
    )
    ...
    return Blockly.zelos.RenderInfo.superClass_.getElemCenterline_.call(
      this,
      a,
      b
    );
  ...
  Blockly.zelos.RenderInfo.prototype.addAlignmentPadding_ = function (a, b) {
    if (a.rightAlignedDummyInput) {
      for (
        var c, d = 0, e;
        (e = a.elements[d]) &&
        (Blockly.blockRendering.Types.isSpacer(e) && (c = e),
        !Blockly.blockRendering.Types.isField(e) ||
          e.parentInput != a.rightAlignedDummyInput);
        d++
      );
      if (c) {
        c.width += b;
  ...
  Blockly.zelos.RenderInfo.prototype.adjustXPosition_ = function () {
    for (
      var a = this.constants_.NOTCH_OFFSET_LEFT + this.constants_.NOTCH_WIDTH,
        b = a,
        c = 2;
      ...
      if (Blockly.blockRendering.Types.isInputRow(e) && e.hasStatement)
        ...
        d &&
        (2 == c || f) &&
        Blockly.blockRendering.Types.isInputRow(e) &&
        !e.hasStatement
      ) {
        f = e.xPos;
        d = null;
        for (var g = 0, h; (h = e.elements[g]); g++)
          Blockly.blockRendering.Types.isSpacer(h) && (d = h),
            !(
              d &&
              (Blockly.blockRendering.Types.isField(h) ||
                Blockly.blockRendering.Types.isInput(h)) &&
              f < b
            ) ||
              (Blockly.blockRendering.Types.isField(h) &&
                (h.field instanceof Blockly.FieldLabel ||
                  h.field instanceof Blockly.FieldImage)) ||
              (d.width += b - f),
            (f += h.width);
      }
    }
  ...
  Blockly.zelos.RenderInfo.prototype.finalizeOutputConnection_ = function () {
    if (this.outputConnection && this.outputConnection.isDynamicShape) {
      for (var a = 0, b = 0, c; (c = this.rows[b]); b++)
        (c.yPos = a), (a += c.height);
      this.height = a;
      b = this.bottomRow.hasNextConnection
      ...
      this.outputConnection.connectionOffsetY = this.outputConnection.shape.connectionOffsetY(
        a
      );
    ...
    if (
      ...
      for (var a = 0, b = 0, c; (c = this.rows[b]); b++)
        if (Blockly.blockRendering.Types.isInputRow(c)) {
          ...
          c.elements.unshift(
            new Blockly.blockRendering.InRowSpacer(this.constants_, -d)
          );
          c.elements.push(
            new Blockly.blockRendering.InRowSpacer(this.constants_, -e)
          );
      ...
      if (a)
        for (
          ...
          Blockly.blockRendering.Types.isTopOrBottomRow(c) &&
  ...
  Blockly.zelos.RenderInfo.prototype.getNegativeSpacing_ = function (a) {
        ...
        case d.SHAPES.ROUND:
          return (
            ...
            b -
              c *
                (1 -
                  Math.sin(Math.acos((c - this.constants_.SMALL_PADDING) / c)))
          );
        default:
          return 0;
      }
    ...
    return Blockly.blockRendering.Types.isField(a)
      ? c == d.SHAPES.ROUND && a.field instanceof Blockly.FieldTextInput
        ? b - 2.75 * d.GRID_UNIT
    ...
    if (!this.outputConnection)
      for (var a = 2; a < this.rows.length - 1; a += 2) {
        ...
        if (e ? this.topRow.hasPreviousConnection : b.followsStatement) {
          var g =
            3 == c.elements.length &&
            (c.elements[1].field instanceof Blockly.FieldLabel ||
              c.elements[1].field instanceof Blockly.FieldImage);
          if (!e && g)
            ...
            for (f = 0; (g = c.elements[f]); f++)
              if (
                Blockly.blockRendering.Types.isInlineInput(g) &&
                g.connectedBlock &&
                !g.connectedBlock.isShadow() &&
                40 <= g.connectedBlock.getHeightWidth().height
              ) {
                e = !0;
                break;
              }
  ...
  Blockly.zelos.Drawer.prototype.draw = function () {
    ...
    this.info_.outputConnection &&
      (a.outputShapeType = this.info_.outputConnection.shape.type);
    a.endDrawing();
  };
      ...
      if (a.precedesStatement || a.followsStatement) {
        ...
        this.outlinePath_ +=
          (a.followsStatement
            ...
            : "") +
          (0 < b ? Blockly.utils.svgPaths.lineOnAxis("V", a.yPos + b) : "") +
          (a.precedesStatement
  ...
  Blockly.zelos.Drawer.prototype.drawInlineInput_ = function (a) {
    ...
    if (!a.connectedBlock && !this.info_.isInsertionMarker) {
      ...
      a =
        ...
        Blockly.utils.svgPaths.lineOnAxis("h", c) +
        a.shape.pathRightDown(a.height) +
        Blockly.utils.svgPaths.lineOnAxis("h", -c) +
        a.shape.pathUp(a.height) +
        "z";
  ...
  Blockly.zelos.Drawer.prototype.drawStatementInput_ = function (a) {
    ...
    b =
      ...
      (b.connectedBottomNextConnection ? "" : b.shape.pathLeft);
    this.outlinePath_ +=
      Blockly.utils.svgPaths.lineOnAxis("H", c) +
      d +
  ...
  Blockly.zelos.PathObject.prototype.applyColour = function (a) {
    ...
    a.isShadow() &&
      a.getParent() &&
      this.svgPath.setAttribute("stroke", a.getParent().style.colourTertiary);
    a = 0;
  ...
  Blockly.zelos.PathObject.prototype.endDrawing = function () {
    if (this.remainingOutlines_)
      for (
        var a = 0, b = Object.keys(this.remainingOutlines_), c;
        (c = b[a]);
        a++
      )
  ...
  Blockly.zelos.PathObject.prototype.getOutlinePath_ = function (a) {
    this.outlines_[a] ||
      (this.outlines_[a] = Blockly.utils.dom.createSvgElement(
        "path",
  ...
  Blockly.zelos.MarkerSvg.prototype.applyColour_ = function (a) {
    ...
    this.isCursor() &&
      this.markerCircle_.firstChild.setAttribute(
        "values",
        this.colour_ + ";transparent;transparent;"
      );
  };
  ...
  Blockly.zelos.Renderer.prototype.getConnectionPreviewMethod = function (
    ...
    return b.type == Blockly.OUTPUT_VALUE
      ...
      : Blockly.zelos.Renderer.superClass_.getConnectionPreviewMethod(a, b, c);
  };
