...
export default function Project(props: ProjectProps) {
    ...
    const [getProjectData, { data, loading, error }] =
        useGetProjectDetailsLazyQuery({
            variables: {
                id: router.query.id as string
            }
        });
    const [editProjectDetails, { loading: editLoading }] =
        useEditProjectDetailsMutation();
    ...
    if (
        ...
        return <Error404 />;
    if (!(data || props.project) || editLoading)
        return <Loader />;
                ...
                <Stack direction="column">
                                                            ...
                                                            cache.modify(
                                                                {
                                                                    ...
                                                                    fields: {
                                                                        user: (
                                                                            ...
                                                                            ...cachedUser,
                                                                            'projects({"isPublic":true,"sortByNewest":true,"take":4})':
                                                                                newUserData
                                                                        })
                                                                    }
                                                                }
                    ...
                    <Stack direction="row" spacing="0.5rem">
                        ...
                        <Chip
                            ...
                            icon={<AccountTree />}
                            label={
                                (proj.children?.length ??
                                    0) +
                                " fork" +
                                (proj.children?.length !== 1
                                    ? "s"
                                    : "")
                            }
                            onClick={
...
export const getServerSideProps: GetServerSideProps<ProjectProps> =
    async (context) => {
