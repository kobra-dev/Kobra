...
(function (root, factory) {
    ...
    updateShape_: function () {
      ...
      for (var a = 0; a < this.itemCount_; a++)
        if (!this.getInput("ADD" + a)) {
          var b = this.appendValueInput("ADD" + a).setAlign(
            Blockly.ALIGN_RIGHT
          );
  ...
  Blockly.Blocks.lists_getSublist = {
    ...
    updateAt_: function (a, b) {
      ...
      var c = new Blockly.FieldDropdown(this["WHERE_OPTIONS_" + a], function (
        c
      ) {
  ...
  Blockly.Blocks.lists_split = {
    ...
    updateType_: function (a) {
      if (this.getFieldValue("MODE") != a) {
        ...
        var c = b.targetBlock();
        c &&
          (b.disconnect(), c.isShadow() ? c.dispose() : this.bumpNeighbours());
      }
      "SPLIT" == a
  ...
  Blockly.Constants.Logic.LOGIC_COMPARE_ONCHANGE_MIXIN = {
    onchange: function (a) {
      ...
      b &&
        c &&
        !b.outputConnection.checkType(c.outputConnection) &&
    ...
    onchange: function (a) {
      ...
      if ((b || c) && d)
        for (var e = 0; 2 > e; e++) {
          var f = 1 == e ? b : c;
          f &&
            !f.outputConnection.checkType(d) &&
            (Blockly.Events.setGroup(a.group),
  ...
  Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    ...
    onchange: function (a) {
      if (
        ...
        !this.workspace.isDragging() &&
        a.type == Blockly.Events.BLOCK_MOVE &&
        a.blockId == this.id
      ) {
        var b = Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.getSurroundLoop(
          this
        );
        this.setWarningText(
          b ? null : Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING
        );
        if (!this.isInFlyout) {
  ...
  Blockly.Blocks.procedures_defnoreturn = {
    ...
    updateVarName: function (a) {
      for (
        var b = a.name, c = !1, d = 0;
        d < this.argumentVarModels_.length;
        d++
      )
        ...
        if (
          ...
          !b ||
            (b.type == this.defType_ &&
              JSON.stringify(b.getVars()) == JSON.stringify(this.arguments_)) ||
            (b = null);
          if (!b) {
            Blockly.Events.setGroup(a.group);
