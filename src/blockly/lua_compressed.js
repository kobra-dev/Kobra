...
(function (root, factory) {
  ...
  Blockly.Lua.init = function (a) {
    ...
    Blockly.Lua.variableDB_
      ...
      : (Blockly.Lua.variableDB_ = new Blockly.Names(
  ...
  Blockly.Lua.multiline_quote_ = function (a) {
    a = a.replace(/\\/g, "\\\\").replace(/\n/g, "\\\n").replace(/'/g, "\\'");
    return "[===" + a + "===]";
  };
  Blockly.Lua.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = Blockly.utils.string.wrap(e, Blockly.Lua.COMMENT_WRAP - 3)),
        (d += Blockly.Lua.prefixLines(e, "-- ") + "\n"));
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type == Blockly.INPUT_VALUE &&
          (e = a.inputList[f].connection.targetBlock()) &&
          (e = Blockly.Lua.allNestedComments(e)) &&
          (d += Blockly.Lua.prefixLines(e, "-- "));
    }
  ...
  Blockly.Lua.colour_picker = function (a) {
    return [
      Blockly.Lua.quote_(a.getFieldValue("COLOUR")),
  ...
  Blockly.Lua.colour_rgb = function (a) {
    var b = Blockly.Lua.provideFunction_("colour_rgb", [
  ...
  Blockly.Lua.colour_blend = function (a) {
    var b = Blockly.Lua.provideFunction_("colour_blend", [
        "function " +
      ...
      c =
        Blockly.Lua.valueToCode(a, "COLOUR1", Blockly.Lua.ORDER_NONE) ||
        "'#000000'",
      d =
        Blockly.Lua.valueToCode(a, "COLOUR2", Blockly.Lua.ORDER_NONE) ||
        "'#000000'";
  ...
  Blockly.Lua.lists_create_with = function (a) {
    for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++)
      b[c] =
        Blockly.Lua.valueToCode(a, "ADD" + c, Blockly.Lua.ORDER_NONE) || "None";
    return ["{" + b.join(", ") + "}", Blockly.Lua.ORDER_HIGH];
  };
  Blockly.Lua.lists_repeat = function (a) {
    var b = Blockly.Lua.provideFunction_("create_list_repeated", [
  ...
  Blockly.Lua.lists_length = function (a) {
    return [
      "#" +
        (Blockly.Lua.valueToCode(a, "VALUE", Blockly.Lua.ORDER_UNARY) || "{}"),
  ...
  Blockly.Lua.lists_indexOf = function (a) {
    ...
    return [
      ("FIRST" == a.getFieldValue("END")
        ? Blockly.Lua.provideFunction_("first_index", [
  ...
  Blockly.Lua.lists_getIndex = function (a) {
    ...
    if ("REMOVE" == b) {
      var f =
        "FROM_END" == c ? Blockly.Lua.ORDER_ADDITIVE : Blockly.Lua.ORDER_NONE;
      a = Blockly.Lua.valueToCode(a, "AT", f) || "1";
      b = Blockly.Lua.variableDB_.getDistinctName(
        "tmp_list",
    ...
    return [
      ("GET" == b
        ? Blockly.Lua.provideFunction_("list_get_" + c.toLowerCase(), [
            "function " +
              Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
              "(t" +
              ("FROM_END" == c || "FROM_START" == c ? ", at)" : ")"),
            "  return t[" + e("t", c, "at") + "]",
            "end",
          ])
        : Blockly.Lua.provideFunction_("list_remove_" + c.toLowerCase(), [
            "function " +
              Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
              "(t" +
              ("FROM_END" == c || "FROM_START" == c ? ", at)" : ")"),
            "  return table.remove(t, " + e("t", c, "at") + ")",
            "end",
          ])) +
        "(" +
        d +
        ("FROM_END" == c || "FROM_START" == c ? ", " + a : "") +
        ")",
      Blockly.Lua.ORDER_HIGH,
    ];
  };
  Blockly.Lua.lists_setIndex = function (a) {
    ...
    var f = Blockly.Lua.lists.getIndex_,
      g = "";
    if (
      ("LAST" == d || "FROM_END" == d || "RANDOM" == d) &&
      !b.match(/^\w+$/)
    ) {
      var h = Blockly.Lua.variableDB_.getDistinctName(
        "tmp_list",
        Blockly.VARIABLE_CATEGORY_NAME
      );
      g = h + " = " + b + "\n";
  ...
  Blockly.Lua.lists_getSublist = function (a) {
    ...
    var f = Blockly.Lua.lists.getIndex_;
    return [
      Blockly.Lua.provideFunction_(
        "list_sublist_" + c.toLowerCase() + "_" + d.toLowerCase(),
        [
          "function " +
            Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
            "(source" +
            ...
            ")",
          "  local t = {}",
          "  local start = " + f("source", c, "at1"),
          "  local finish = " + f("source", d, "at2"),
  ...
  Blockly.Lua.lists_sort = function (a) {
    ...
    return [
      Blockly.Lua.provideFunction_("list_sort", [
        "function " +
          Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Lua.lists_split = function (a) {
    ...
    if ("SPLIT" == a)
      b || (b = "''"),
        (a = Blockly.Lua.provideFunction_("list_string_split", [
          "function " +
            Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
            "(input, delim)",
          "  local t = {}",
  ...
  Blockly.Lua.lists_reverse = function (a) {
    ...
    return [
      Blockly.Lua.provideFunction_("list_reverse", [
  ...
  Blockly.Lua.controls_if = function (a) {
    var b = 0,
      c = "";
    Blockly.Lua.STATEMENT_PREFIX &&
      (c += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_PREFIX, a));
    do {
      var d =
        Blockly.Lua.valueToCode(a, "IF" + b, Blockly.Lua.ORDER_NONE) || "false";
      var e = Blockly.Lua.statementToCode(a, "DO" + b);
      Blockly.Lua.STATEMENT_SUFFIX &&
        (e =
          Blockly.Lua.prefixLines(
            Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a),
            Blockly.Lua.INDENT
          ) + e);
      c += (0 < b ? "else" : "") + "if " + d + " then\n" + e;
      ++b;
    } while (a.getInput("IF" + b));
    if (a.getInput("ELSE") || Blockly.Lua.STATEMENT_SUFFIX)
      (e = Blockly.Lua.statementToCode(a, "ELSE")),
        Blockly.Lua.STATEMENT_SUFFIX &&
          (e =
            Blockly.Lua.prefixLines(
              Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a),
  ...
  Blockly.Lua.logic_negate = function (a) {
    return [
      "not " +
        (Blockly.Lua.valueToCode(a, "BOOL", Blockly.Lua.ORDER_UNARY) || "true"),
      Blockly.Lua.ORDER_UNARY,
    ];
  };
  ...
  Blockly.Lua.addContinueLabel_ = function (a) {
    return -1 != a.indexOf(Blockly.Lua.CONTINUE_STATEMENT)
      ? a + Blockly.Lua.INDENT + "::continue::\n"
      : a;
  };
  Blockly.Lua.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
      ? String(Number(a.getFieldValue("TIMES")))
      : Blockly.Lua.valueToCode(a, "TIMES", Blockly.Lua.ORDER_NONE) || "0";
    ...
    return (
      "for " +
      Blockly.Lua.variableDB_.getDistinctName(
        "count",
        Blockly.VARIABLE_CATEGORY_NAME
      ) +
      " = 1, " +
    ...
    var b = "UNTIL" == a.getFieldValue("MODE"),
      c =
        Blockly.Lua.valueToCode(
          a,
          "BOOL",
          b ? Blockly.Lua.ORDER_UNARY : Blockly.Lua.ORDER_NONE
        ) || "false",
  ...
  Blockly.Lua.controls_for = function (a) {
    var b = Blockly.Lua.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
      ),
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e))
      var g = (Number(c) <= Number(d) ? "" : "-") + Math.abs(Number(e));
    else
      (a = ""),
        (g = Blockly.Lua.variableDB_.getDistinctName(
          b + "_inc",
          Blockly.VARIABLE_CATEGORY_NAME
        )),
        (a += g + " = "),
  ...
  Blockly.Lua.controls_flow_statements = function (a) {
    var b = "";
    Blockly.Lua.STATEMENT_PREFIX &&
      (b += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_PREFIX, a));
    Blockly.Lua.STATEMENT_SUFFIX &&
      (b += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a));
    if (Blockly.Lua.STATEMENT_PREFIX) {
      ...
      c &&
        ...
        (b += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_PREFIX, c));
    }
  ...
  Blockly.Lua.math_single = function (a) {
    ...
    if ("NEG" == b)
      return (
        (a = Blockly.Lua.valueToCode(a, "NUM", Blockly.Lua.ORDER_UNARY) || "0"),
        ["-" + a, Blockly.Lua.ORDER_UNARY]
      );
    if ("POW10" == b)
      return (
        (a =
          Blockly.Lua.valueToCode(a, "NUM", Blockly.Lua.ORDER_EXPONENTIATION) ||
          "0"),
        ["10 ^ " + a, Blockly.Lua.ORDER_EXPONENTIATION]
      );
    a =
      "ROUND" == b
        ? Blockly.Lua.valueToCode(a, "NUM", Blockly.Lua.ORDER_ADDITIVE) || "0"
        : Blockly.Lua.valueToCode(a, "NUM", Blockly.Lua.ORDER_NONE) || "0";
    switch (b) {
      case "ABS":
        b = "math.abs(" + a + ")";
        break;
  ...
  Blockly.Lua.math_number_property = function (a) {
    ...
    if ("PRIME" == c)
      return [
        Blockly.Lua.provideFunction_("math_isPrime", [
  ...
  Blockly.Lua.math_change = function (a) {
    var b =
      Blockly.Lua.valueToCode(a, "DELTA", Blockly.Lua.ORDER_ADDITIVE) || "0";
    a = Blockly.Lua.variableDB_.getName(
      a.getFieldValue("VAR"),
      Blockly.VARIABLE_CATEGORY_NAME
    );
    return a + " = " + a + " + " + b + "\n";
  ...
  Blockly.Lua.math_on_list = function (a) {
    ...
    switch (c) {
      case "SUM":
        ...
        break;
      case "MIN":
        c = Blockly.Lua.provideFunction_("math_min", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  if #t == 0 then",
          "    return 0",
          "  end",
        ...
        break;
      case "AVERAGE":
        c = Blockly.Lua.provideFunction_("math_average", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  if #t == 0 then",
          "    return 0",
          "  end",
        ...
        break;
      case "MAX":
        c = Blockly.Lua.provideFunction_("math_max", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  if #t == 0 then",
          "    return 0",
          "  end",
        ...
        break;
      case "MEDIAN":
        c = Blockly.Lua.provideFunction_("math_median", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
        ...
        break;
      case "MODE":
        c = Blockly.Lua.provideFunction_("math_modes", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  -- Source: http://lua-users.org/wiki/SimpleStats",
          "  local counts={}",
          "  for _, v in ipairs(t) do",
        ...
        break;
      case "STD_DEV":
        c = Blockly.Lua.provideFunction_("math_standard_deviation", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  local m",
          "  local vm",
          "  local total = 0",
        ...
        break;
      case "RANDOM":
        c = Blockly.Lua.provideFunction_("math_random_list", [
          "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(t)",
          "  if #t == 0 then",
          "    return nil",
          "  end",
  ...
  Blockly.Lua.math_modulo = function (a) {
    ...
    a =
      Blockly.Lua.valueToCode(a, "DIVISOR", Blockly.Lua.ORDER_MULTIPLICATIVE) ||
      "0";
  ...
  Blockly.Lua.math_constrain = function (a) {
    var b = Blockly.Lua.valueToCode(a, "VALUE", Blockly.Lua.ORDER_NONE) || "0",
      c =
        Blockly.Lua.valueToCode(a, "LOW", Blockly.Lua.ORDER_NONE) ||
        "-math.huge";
    a =
      Blockly.Lua.valueToCode(a, "HIGH", Blockly.Lua.ORDER_NONE) || "math.huge";
    return [
  ...
  Blockly.Lua.math_atan2 = function (a) {
    ...
    return [
      "math.deg(math.atan2(" +
        (Blockly.Lua.valueToCode(a, "Y", Blockly.Lua.ORDER_NONE) || "0") +
        ", " +
        b +
        "))",
      Blockly.Lua.ORDER_HIGH,
  ...
  Blockly.Lua.procedures_defreturn = function (a) {
    ...
    Blockly.Lua.STATEMENT_PREFIX &&
      (c += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_PREFIX, a));
    Blockly.Lua.STATEMENT_SUFFIX &&
      (c += Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a));
    c && (c = Blockly.Lua.prefixLines(c, Blockly.Lua.INDENT));
    var d = "";
    Blockly.Lua.INFINITE_LOOP_TRAP &&
      (d = Blockly.Lua.prefixLines(
        Blockly.Lua.injectId(Blockly.Lua.INFINITE_LOOP_TRAP, a),
        Blockly.Lua.INDENT
      ));
    ...
    for (var h = [], l = a.getVars(), k = 0; k < l.length; k++)
      h[k] = Blockly.Lua.variableDB_.getName(
        l[k],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    c =
  ...
  Blockly.Lua.procedures_callreturn = function (a) {
    for (
      ...
      c[e] =
        Blockly.Lua.valueToCode(a, "ARG" + e, Blockly.Lua.ORDER_NONE) || "nil";
  ...
  Blockly.Lua.procedures_ifreturn = function (a) {
    var b =
      "if " +
      (Blockly.Lua.valueToCode(a, "CONDITION", Blockly.Lua.ORDER_NONE) ||
        "false") +
      " then\n";
    Blockly.Lua.STATEMENT_SUFFIX &&
      (b += Blockly.Lua.prefixLines(
        Blockly.Lua.injectId(Blockly.Lua.STATEMENT_SUFFIX, a),
        Blockly.Lua.INDENT
      ));
    a.hasReturnValue_
      ? ((a =
          Blockly.Lua.valueToCode(a, "VALUE", Blockly.Lua.ORDER_NONE) || "nil"),
        (b += Blockly.Lua.INDENT + "return " + a + "\n"))
  ...
  Blockly.Lua.text = function (a) {
    return [
      Blockly.Lua.quote_(a.getFieldValue("TEXT")),
      Blockly.Lua.ORDER_ATOMIC,
    ];
  };
  Blockly.Lua.text_multiline = function (a) {
    return [
      Blockly.Lua.multiline_quote_(a.getFieldValue("TEXT")),
      Blockly.Lua.ORDER_ATOMIC,
    ];
  };
  Blockly.Lua.text_join = function (a) {
    ...
    if (1 == a.itemCount_)
      return [
        "tostring(" +
          (Blockly.Lua.valueToCode(a, "ADD0", Blockly.Lua.ORDER_NONE) || "''") +
          ")",
        Blockly.Lua.ORDER_HIGH,
      ];
    if (2 == a.itemCount_) {
      var b =
        Blockly.Lua.valueToCode(a, "ADD0", Blockly.Lua.ORDER_CONCATENATION) ||
        "''";
      a =
        Blockly.Lua.valueToCode(a, "ADD1", Blockly.Lua.ORDER_CONCATENATION) ||
        "''";
    ...
    for (var c = 0; c < a.itemCount_; c++)
      b[c] =
        Blockly.Lua.valueToCode(a, "ADD" + c, Blockly.Lua.ORDER_NONE) || "''";
  ...
  Blockly.Lua.text_append = function (a) {
    ...
    a =
      Blockly.Lua.valueToCode(a, "TEXT", Blockly.Lua.ORDER_CONCATENATION) ||
      "''";
    return b + " = " + b + " .. " + a + "\n";
  };
  ...
  Blockly.Lua.text_indexOf = function (a) {
    ...
    return [
      ("FIRST" == a.getFieldValue("END")
        ? Blockly.Lua.provideFunction_("firstIndexOf", [
            "function " +
              Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
              "(str, substr) ",
    ...
    var b = a.getFieldValue("WHERE") || "FROM_START",
      c =
        Blockly.Lua.valueToCode(
          a,
          "AT",
          "FROM_END" == b ? Blockly.Lua.ORDER_UNARY : Blockly.Lua.ORDER_NONE
        ) || "1";
    a = Blockly.Lua.valueToCode(a, "VALUE", Blockly.Lua.ORDER_NONE) || "''";
    if ("RANDOM" == b)
      (b = Blockly.Lua.provideFunction_("text_random_letter", [
      ...
      else if ("FROM_START" != b)
        if ("FROM_END" == b) c = "-" + c;
        else throw Error("Unhandled option (text_charAt).");
      c.match(/^-?\w*$/)
        ? (a = "string.sub(" + a + ", " + c + ", " + c + ")")
        : ((b = Blockly.Lua.provideFunction_("text_char_at", [
            "function " +
              Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
              "(str, index)",
            "  return string.sub(str, index, index)",
  ...
  Blockly.Lua.text_getSubstring = function (a) {
    var b =
        Blockly.Lua.valueToCode(a, "STRING", Blockly.Lua.ORDER_NONE) || "''",
      c = a.getFieldValue("WHERE1"),
      d =
        Blockly.Lua.valueToCode(
          a,
          "AT1",
          "FROM_END" == c ? Blockly.Lua.ORDER_UNARY : Blockly.Lua.ORDER_NONE
        ) || "1";
    if ("FIRST" == c) c = 1;
    ...
    a =
      Blockly.Lua.valueToCode(
        a,
        "AT2",
        "FROM_END" == d ? Blockly.Lua.ORDER_UNARY : Blockly.Lua.ORDER_NONE
      ) || "1";
    if ("LAST" == d) a = -1;
  ...
  Blockly.Lua.text_changeCase = function (a) {
    ...
    if ("UPPERCASE" == b) var c = "string.upper";
      ...
      "LOWERCASE" == b
        ? (c = "string.lower")
        : "TITLECASE" == b &&
          (c = Blockly.Lua.provideFunction_("text_titlecase", [
            "function " + Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ + "(str)",
            "  local buf = {}",
            "  local inWord = false",
            "  for i = 1, #str do",
  ...
  Blockly.Lua.text_trim = function (a) {
    var b = { LEFT: "^%s*(,-)", RIGHT: "(.-)%s*$", BOTH: "^%s*(.-)%s*$" }[
      a.getFieldValue("MODE")
    ];
    return [
      "string.gsub(" +
        (Blockly.Lua.valueToCode(a, "TEXT", Blockly.Lua.ORDER_NONE) || "''") +
        ', "' +
        b +
        '", "%1")',
      Blockly.Lua.ORDER_HIGH,
  ...
  Blockly.Lua.text_prompt_ext = function (a) {
    var b = a.getField("TEXT")
      ? Blockly.Lua.quote_(a.getFieldValue("TEXT"))
      : Blockly.Lua.valueToCode(a, "TEXT", Blockly.Lua.ORDER_NONE) || "''";
    b =
      Blockly.Lua.provideFunction_("text_prompt", [
  ...
  Blockly.Lua.text_count = function (a) {
    ...
    return [
      Blockly.Lua.provideFunction_("text_count", [
        "function " +
          Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
          "(haystack, needle)",
        "  if #needle == 0 then",
  ...
  Blockly.Lua.text_replace = function (a) {
    ...
    return [
      Blockly.Lua.provideFunction_("text_replace", [
        "function " +
          Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.Lua.text_reverse = function (a) {
    return [
      "string.reverse(" +
        (Blockly.Lua.valueToCode(a, "TEXT", Blockly.Lua.ORDER_HIGH) || "''") +
        ")",
      Blockly.Lua.ORDER_HIGH,
    ];
  };
  ...
  Blockly.Lua.variables_get = function (a) {
    return [
      Blockly.Lua.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      Blockly.Lua.ORDER_ATOMIC,
