// This is copied from https://github.com/timc1/kbar/blob/main/src/useStore.tsx
// because it isn't exported from the kbar module and the KBarContextProvider_patched needs it

import { deepEqual } from "fast-equals";
import * as React from "react";
import { ActionInterface } from "kbar";
import {
    Action,
    IKBarContext,
    KBarOptions,
...
// Can't import history but I don't think we were going to use that anyway
    ...
    const actionsInterface = React.useMemo(
        () =>
            new ActionInterface(props.actions || [], {
                historyManager:
                    /*optionsRef.current.enableHistory ? history : */ undefined
            }),
            ...
            query: {
                ...
                setActiveIndex: (cb) =>
                    setState((state) => ({
                        ...state,
                        activeIndex:
                            typeof cb === "number" ? cb : cb(state.activeIndex)
                    }))
            },
